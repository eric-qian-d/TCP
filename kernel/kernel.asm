...
printint(int xx, int base, int sign)
{
  ...
  do {
    ...
    800004da:	88260613          	addi	a2,a2,-1918 # 80009d58 <digits>
...
00000000800005b4 <printf>:
{
  ...
  consputc('x');
    ...
    80000616:	746b8b93          	addi	s7,s7,1862 # 80009d58 <digits>
    switch(c){
...
main()
{
  ...
  scheduler();        
    ...
    80001030:	4c6080e7          	jalr	1222(ra) # 800074f2 <pci_init>
    sockinit();
    80001034:	00006097          	auipc	ra,0x6
    80001038:	090080e7          	jalr	144(ra) # 800070c4 <sockinit>
    userinit();      // first user process
...
00000000800019a6 <procinit>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800019ea:	58ab0b13          	addi	s6,s6,1418 # 80009f70 <syscalls+0xc0>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800025be:	7b6b8b93          	addi	s7,s7,1974 # 80009d70 <states.1828>
...
scause_desc(uint64 stval)
{
  ...
  if (interrupt) {
    ...
    800026fe:	69e78793          	addi	a5,a5,1694 # 80009d98 <intr_desc.1645>
    ...
    80002712:	68a78793          	addi	a5,a5,1674 # 80009d98 <intr_desc.1645>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80002ae8:	3b470713          	addi	a4,a4,948 # 80009e98 <nointr_desc.1646+0x80>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002c70:	24478793          	addi	a5,a5,580 # 80009eb0 <syscalls>
...
fileclose(struct file *f)
{
  ...
  if(ff.type == FD_PIPE){
    ...
    800047a4:	a72080e7          	jalr	-1422(ra) # 80007212 <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    800048a6:	aba080e7          	jalr	-1350(ra) # 8000735c <sockread>
    ...
    800048fa:	14078f63          	beqz	a5,80004a58 <filewrite+0x162>
{
  ...
  if(f->type == FD_PIPE){
    ...
    8000495c:	96a080e7          	jalr	-1686(ra) # 800072c2 <sockwrite>
...
0000000080005328 <sys_connect>:
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    80005380:	d70080e7          	jalr	-656(ra) # 800070ec <sockalloc>
    return -1;
...
void net_rx(struct mbuf *m)
{
  ...
  if (!ethhdr) {
    80006d04:	c521                	beqz	a0,80006d4c <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80006d06:	00c54783          	lbu	a5,12(a0)
    80006d0a:	00d54703          	lbu	a4,13(a0)
    80006d0e:	0722                	slli	a4,a4,0x8
    80006d10:	8fd9                	or	a5,a5,a4
    80006d12:	0087979b          	slliw	a5,a5,0x8
    80006d16:	8321                	srli	a4,a4,0x8
    80006d18:	8fd9                	or	a5,a5,a4
    80006d1a:	17c2                	slli	a5,a5,0x30
    80006d1c:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP) {
    80006d1e:	8007871b          	addiw	a4,a5,-2048
    80006d22:	cb1d                	beqz	a4,80006d58 <net_rx+0x72>
    // printf("IP\n");
    net_rx_ip(m);
  }
  else if (type == ETHTYPE_ARP) {
    80006d24:	2781                	sext.w	a5,a5
    80006d26:	6705                	lui	a4,0x1
    80006d28:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80006d2c:	18e78463          	beq	a5,a4,80006eb4 <net_rx+0x1ce>
  kfree(m);
    80006d30:	8526                	mv	a0,s1
    80006d32:	ffffa097          	auipc	ra,0xffffa
    80006d36:	b4a080e7          	jalr	-1206(ra) # 8000087c <kfree>
  else {
    // printf("WTF\n");
    // printf("%u", type);
    mbuffree(m);
    ...
    80006d3a:	60a6                	ld	ra,72(sp)
    80006d3c:	6406                	ld	s0,64(sp)
    80006d3e:	74e2                	ld	s1,56(sp)
    80006d40:	7942                	ld	s2,48(sp)
    80006d42:	79a2                	ld	s3,40(sp)
    80006d44:	7a02                	ld	s4,32(sp)
    80006d46:	6ae2                	ld	s5,24(sp)
    80006d48:	6161                	addi	sp,sp,80
    80006d4a:	8082                	ret
  kfree(m);
    80006d4c:	8526                	mv	a0,s1
    80006d4e:	ffffa097          	auipc	ra,0xffffa
    80006d52:	b2e080e7          	jalr	-1234(ra) # 8000087c <kfree>
}
    80006d56:	b7d5                	j	80006d3a <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80006d58:	45d1                	li	a1,20
    80006d5a:	8526                	mv	a0,s1
    80006d5c:	00000097          	auipc	ra,0x0
    80006d60:	c8e080e7          	jalr	-882(ra) # 800069ea <mbufpull>
    80006d64:	892a                	mv	s2,a0
  if (!iphdr)
    80006d66:	c519                	beqz	a0,80006d74 <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80006d68:	00054703          	lbu	a4,0(a0)
    80006d6c:	04500793          	li	a5,69
    80006d70:	00f70863          	beq	a4,a5,80006d80 <net_rx+0x9a>
  kfree(m);
    80006d74:	8526                	mv	a0,s1
    80006d76:	ffffa097          	auipc	ra,0xffffa
    80006d7a:	b06080e7          	jalr	-1274(ra) # 8000087c <kfree>
}
    80006d7e:	bf75                	j	80006d3a <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80006d80:	45d1                	li	a1,20
    80006d82:	00000097          	auipc	ra,0x0
    80006d86:	bf4080e7          	jalr	-1036(ra) # 80006976 <in_cksum>
    80006d8a:	f56d                	bnez	a0,80006d74 <net_rx+0x8e>
    80006d8c:	00695783          	lhu	a5,6(s2)
    80006d90:	0087d71b          	srliw	a4,a5,0x8
    80006d94:	0087979b          	slliw	a5,a5,0x8
    80006d98:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80006d9a:	17c2                	slli	a5,a5,0x30
    80006d9c:	93c1                	srli	a5,a5,0x30
    80006d9e:	fbf9                	bnez	a5,80006d74 <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80006da0:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80006da4:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80006da8:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006dac:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80006dae:	0087169b          	slliw	a3,a4,0x8
    80006db2:	00ff0637          	lui	a2,0xff0
    80006db6:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80006db8:	8fd5                	or	a5,a5,a3
    80006dba:	0087571b          	srliw	a4,a4,0x8
    80006dbe:	66c1                	lui	a3,0x10
    80006dc0:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006dc4:	8f75                	and	a4,a4,a3
    80006dc6:	8fd9                	or	a5,a5,a4
    80006dc8:	2781                	sext.w	a5,a5
    80006dca:	0a000737          	lui	a4,0xa000
    80006dce:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80006dd2:	fae791e3          	bne	a5,a4,80006d74 <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80006dd6:	00994703          	lbu	a4,9(s2)
    80006dda:	47c5                	li	a5,17
    80006ddc:	f8f71ce3          	bne	a4,a5,80006d74 <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80006de0:	00295783          	lhu	a5,2(s2)
    80006de4:	0087d71b          	srliw	a4,a5,0x8
    80006de8:	0087999b          	slliw	s3,a5,0x8
    80006dec:	00e9e9b3          	or	s3,s3,a4
    80006df0:	19c2                	slli	s3,s3,0x30
    80006df2:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80006df6:	fec9879b          	addiw	a5,s3,-20
    80006dfa:	03079a13          	slli	s4,a5,0x30
    80006dfe:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80006e02:	45a1                	li	a1,8
    80006e04:	8526                	mv	a0,s1
    80006e06:	00000097          	auipc	ra,0x0
    80006e0a:	be4080e7          	jalr	-1052(ra) # 800069ea <mbufpull>
    80006e0e:	8aaa                	mv	s5,a0
  if (!udphdr)
    80006e10:	c905                	beqz	a0,80006e40 <net_rx+0x15a>
    80006e12:	00455783          	lhu	a5,4(a0)
    80006e16:	0087d71b          	srliw	a4,a5,0x8
    80006e1a:	0087979b          	slliw	a5,a5,0x8
    80006e1e:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80006e20:	2a01                	sext.w	s4,s4
    80006e22:	17c2                	slli	a5,a5,0x30
    80006e24:	93c1                	srli	a5,a5,0x30
    80006e26:	00fa1d63          	bne	s4,a5,80006e40 <net_rx+0x15a>
  len -= sizeof(*udphdr);
    80006e2a:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80006e2e:	0107979b          	slliw	a5,a5,0x10
    80006e32:	0107d79b          	srliw	a5,a5,0x10
    80006e36:	0007871b          	sext.w	a4,a5
    80006e3a:	488c                	lw	a1,16(s1)
    80006e3c:	00e5f863          	bgeu	a1,a4,80006e4c <net_rx+0x166>
  kfree(m);
    80006e40:	8526                	mv	a0,s1
    80006e42:	ffffa097          	auipc	ra,0xffffa
    80006e46:	a3a080e7          	jalr	-1478(ra) # 8000087c <kfree>
}
    80006e4a:	bdc5                	j	80006d3a <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80006e4c:	9d9d                	subw	a1,a1,a5
    80006e4e:	8526                	mv	a0,s1
    80006e50:	00000097          	auipc	ra,0x0
    80006e54:	ca8080e7          	jalr	-856(ra) # 80006af8 <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80006e58:	00c92783          	lw	a5,12(s2)
    80006e5c:	000ad703          	lhu	a4,0(s5)
    80006e60:	0087569b          	srliw	a3,a4,0x8
    80006e64:	0087171b          	slliw	a4,a4,0x8
    80006e68:	8ed9                	or	a3,a3,a4
    80006e6a:	002ad703          	lhu	a4,2(s5)
    80006e6e:	0087561b          	srliw	a2,a4,0x8
    80006e72:	0087171b          	slliw	a4,a4,0x8
    80006e76:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    80006e78:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006e7c:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006e80:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    80006e82:	0087959b          	slliw	a1,a5,0x8
    80006e86:	00ff0537          	lui	a0,0xff0
    80006e8a:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    80006e8c:	8f4d                	or	a4,a4,a1
    80006e8e:	0087d79b          	srliw	a5,a5,0x8
    80006e92:	65c1                	lui	a1,0x10
    80006e94:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80006e98:	8fed                	and	a5,a5,a1
    80006e9a:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    80006e9c:	16c2                	slli	a3,a3,0x30
    80006e9e:	92c1                	srli	a3,a3,0x30
    80006ea0:	1642                	slli	a2,a2,0x30
    80006ea2:	9241                	srli	a2,a2,0x30
    80006ea4:	0007859b          	sext.w	a1,a5
    80006ea8:	8526                	mv	a0,s1
    80006eaa:	00000097          	auipc	ra,0x0
    80006eae:	580080e7          	jalr	1408(ra) # 8000742a <sockrecvudp>
  return;
    80006eb2:	b561                	j	80006d3a <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    80006eb4:	45f1                	li	a1,28
    80006eb6:	8526                	mv	a0,s1
    80006eb8:	00000097          	auipc	ra,0x0
    80006ebc:	b32080e7          	jalr	-1230(ra) # 800069ea <mbufpull>
    80006ec0:	892a                	mv	s2,a0
  if (!arphdr)
    80006ec2:	c179                	beqz	a0,80006f88 <net_rx+0x2a2>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006ec4:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    80006ec8:	00154703          	lbu	a4,1(a0)
    80006ecc:	0722                	slli	a4,a4,0x8
    80006ece:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    80006ed0:	0087979b          	slliw	a5,a5,0x8
    80006ed4:	8321                	srli	a4,a4,0x8
    80006ed6:	8fd9                	or	a5,a5,a4
    80006ed8:	17c2                	slli	a5,a5,0x30
    80006eda:	93c1                	srli	a5,a5,0x30
    80006edc:	4705                	li	a4,1
    80006ede:	0ae79563          	bne	a5,a4,80006f88 <net_rx+0x2a2>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006ee2:	00254783          	lbu	a5,2(a0)
    80006ee6:	00354703          	lbu	a4,3(a0)
    80006eea:	0722                	slli	a4,a4,0x8
    80006eec:	8fd9                	or	a5,a5,a4
    80006eee:	0087979b          	slliw	a5,a5,0x8
    80006ef2:	8321                	srli	a4,a4,0x8
    80006ef4:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006ef6:	0107979b          	slliw	a5,a5,0x10
    80006efa:	0107d79b          	srliw	a5,a5,0x10
    80006efe:	8007879b          	addiw	a5,a5,-2048
    80006f02:	e3d9                	bnez	a5,80006f88 <net_rx+0x2a2>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006f04:	00454703          	lbu	a4,4(a0)
    80006f08:	4799                	li	a5,6
    80006f0a:	06f71f63          	bne	a4,a5,80006f88 <net_rx+0x2a2>
      arphdr->hln != ETHADDR_LEN ||
    80006f0e:	00554703          	lbu	a4,5(a0)
    80006f12:	4791                	li	a5,4
    80006f14:	06f71a63          	bne	a4,a5,80006f88 <net_rx+0x2a2>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006f18:	00654783          	lbu	a5,6(a0)
    80006f1c:	00754703          	lbu	a4,7(a0)
    80006f20:	0722                	slli	a4,a4,0x8
    80006f22:	8fd9                	or	a5,a5,a4
    80006f24:	0087979b          	slliw	a5,a5,0x8
    80006f28:	8321                	srli	a4,a4,0x8
    80006f2a:	8fd9                	or	a5,a5,a4
    80006f2c:	17c2                	slli	a5,a5,0x30
    80006f2e:	93c1                	srli	a5,a5,0x30
    80006f30:	4705                	li	a4,1
    80006f32:	04e79b63          	bne	a5,a4,80006f88 <net_rx+0x2a2>
  tip = ntohl(arphdr->tip); // target IP address
    80006f36:	01854783          	lbu	a5,24(a0)
    80006f3a:	01954703          	lbu	a4,25(a0)
    80006f3e:	0722                	slli	a4,a4,0x8
    80006f40:	8f5d                	or	a4,a4,a5
    80006f42:	01a54783          	lbu	a5,26(a0)
    80006f46:	07c2                	slli	a5,a5,0x10
    80006f48:	8f5d                	or	a4,a4,a5
    80006f4a:	01b54783          	lbu	a5,27(a0)
    80006f4e:	07e2                	slli	a5,a5,0x18
    80006f50:	8fd9                	or	a5,a5,a4
    80006f52:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006f56:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006f5a:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006f5e:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80006f60:	0087169b          	slliw	a3,a4,0x8
    80006f64:	00ff0637          	lui	a2,0xff0
    80006f68:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80006f6a:	8fd5                	or	a5,a5,a3
    80006f6c:	0087571b          	srliw	a4,a4,0x8
    80006f70:	66c1                	lui	a3,0x10
    80006f72:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006f76:	8f75                	and	a4,a4,a3
    80006f78:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006f7a:	2781                	sext.w	a5,a5
    80006f7c:	0a000737          	lui	a4,0xa000
    80006f80:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80006f84:	00e78863          	beq	a5,a4,80006f94 <net_rx+0x2ae>
  kfree(m);
    80006f88:	8526                	mv	a0,s1
    80006f8a:	ffffa097          	auipc	ra,0xffffa
    80006f8e:	8f2080e7          	jalr	-1806(ra) # 8000087c <kfree>
}
    80006f92:	b365                	j	80006d3a <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    80006f94:	4619                	li	a2,6
    80006f96:	00850593          	addi	a1,a0,8
    80006f9a:	fb840513          	addi	a0,s0,-72
    80006f9e:	ffffa097          	auipc	ra,0xffffa
    80006fa2:	e3c080e7          	jalr	-452(ra) # 80000dda <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    80006fa6:	00e94783          	lbu	a5,14(s2)
    80006faa:	00f94703          	lbu	a4,15(s2)
    80006fae:	0722                	slli	a4,a4,0x8
    80006fb0:	8f5d                	or	a4,a4,a5
    80006fb2:	01094783          	lbu	a5,16(s2)
    80006fb6:	07c2                	slli	a5,a5,0x10
    80006fb8:	8f5d                	or	a4,a4,a5
    80006fba:	01194783          	lbu	a5,17(s2)
    80006fbe:	07e2                	slli	a5,a5,0x18
    80006fc0:	8fd9                	or	a5,a5,a4
    80006fc2:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006fc6:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006fca:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006fce:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    80006fd2:	0087179b          	slliw	a5,a4,0x8
    80006fd6:	00ff06b7          	lui	a3,0xff0
    80006fda:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006fdc:	00f96933          	or	s2,s2,a5
    80006fe0:	0087579b          	srliw	a5,a4,0x8
    80006fe4:	6741                	lui	a4,0x10
    80006fe6:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80006fea:	8ff9                	and	a5,a5,a4
    80006fec:	00f96933          	or	s2,s2,a5
    80006ff0:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006ff2:	08000513          	li	a0,128
    80006ff6:	00000097          	auipc	ra,0x0
    80006ffa:	b24080e7          	jalr	-1244(ra) # 80006b1a <mbufalloc>
    80006ffe:	8a2a                	mv	s4,a0
  if (!m)
    80007000:	d541                	beqz	a0,80006f88 <net_rx+0x2a2>
  arphdr = mbufputhdr(m, *arphdr);
    80007002:	45f1                	li	a1,28
    80007004:	00000097          	auipc	ra,0x0
    80007008:	aba080e7          	jalr	-1350(ra) # 80006abe <mbufput>
    8000700c:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    8000700e:	00050023          	sb	zero,0(a0)
    80007012:	4785                	li	a5,1
    80007014:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    80007018:	47a1                	li	a5,8
    8000701a:	00f50123          	sb	a5,2(a0)
    8000701e:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    80007022:	4799                	li	a5,6
    80007024:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    80007028:	4791                	li	a5,4
    8000702a:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    8000702e:	00050323          	sb	zero,6(a0)
    80007032:	4a89                	li	s5,2
    80007034:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    80007038:	4619                	li	a2,6
    8000703a:	00003597          	auipc	a1,0x3
    8000703e:	00e58593          	addi	a1,a1,14 # 8000a048 <local_mac>
    80007042:	0521                	addi	a0,a0,8
    80007044:	ffffa097          	auipc	ra,0xffffa
    80007048:	d96080e7          	jalr	-618(ra) # 80000dda <memmove>
  arphdr->sip = htonl(local_ip);
    8000704c:	47a9                	li	a5,10
    8000704e:	00f98723          	sb	a5,14(s3)
    80007052:	000987a3          	sb	zero,15(s3)
    80007056:	01598823          	sb	s5,16(s3)
    8000705a:	47bd                	li	a5,15
    8000705c:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    80007060:	4619                	li	a2,6
    80007062:	fb840593          	addi	a1,s0,-72
    80007066:	01298513          	addi	a0,s3,18
    8000706a:	ffffa097          	auipc	ra,0xffffa
    8000706e:	d70080e7          	jalr	-656(ra) # 80000dda <memmove>
  return (((val & 0x000000ffUL) << 24) |
    80007072:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    80007076:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000707a:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    8000707c:	0089179b          	slliw	a5,s2,0x8
    80007080:	00ff06b7          	lui	a3,0xff0
    80007084:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80007086:	8f5d                	or	a4,a4,a5
    80007088:	0089579b          	srliw	a5,s2,0x8
    8000708c:	66c1                	lui	a3,0x10
    8000708e:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80007092:	8ff5                	and	a5,a5,a3
    80007094:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    80007096:	00e98c23          	sb	a4,24(s3)
    8000709a:	0087d71b          	srliw	a4,a5,0x8
    8000709e:	00e98ca3          	sb	a4,25(s3)
    800070a2:	0107d71b          	srliw	a4,a5,0x10
    800070a6:	00e98d23          	sb	a4,26(s3)
    800070aa:	0187d79b          	srliw	a5,a5,0x18
    800070ae:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    800070b2:	6585                	lui	a1,0x1
    800070b4:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    800070b8:	8552                	mv	a0,s4
    800070ba:	00000097          	auipc	ra,0x0
    800070be:	98c080e7          	jalr	-1652(ra) # 80006a46 <net_tx_eth>
  return 0;
    800070c2:	b5d9                	j	80006f88 <net_rx+0x2a2>

00000000800070c4 <sockinit>:
...
sockinit(void)
{
    ...
    800070c8:	e022                	sd	s0,0(sp)
    800070ca:	0800                	addi	s0,sp,16
  initlock(&lock, "socktbl");
    800070cc:	00003597          	auipc	a1,0x3
    800070d0:	b4458593          	addi	a1,a1,-1212 # 80009c10 <userret+0xb80>
    800070d4:	00022517          	auipc	a0,0x22
    800070d8:	24c50513          	addi	a0,a0,588 # 80029320 <lock>
    800070dc:	ffffa097          	auipc	ra,0xffffa
    800070e0:	8fc080e7          	jalr	-1796(ra) # 800009d8 <initlock>
}
    800070e4:	60a2                	ld	ra,8(sp)
    800070e6:	6402                	ld	s0,0(sp)
    800070e8:	0141                	addi	sp,sp,16
    800070ea:	8082                	ret

00000000800070ec <sockalloc>:

int
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    800070ec:	7139                	addi	sp,sp,-64
    800070ee:	fc06                	sd	ra,56(sp)
    800070f0:	f822                	sd	s0,48(sp)
    800070f2:	f426                	sd	s1,40(sp)
    800070f4:	f04a                	sd	s2,32(sp)
    800070f6:	ec4e                	sd	s3,24(sp)
    800070f8:	e852                	sd	s4,16(sp)
    800070fa:	e456                	sd	s5,8(sp)
    800070fc:	0080                	addi	s0,sp,64
    800070fe:	892a                	mv	s2,a0
    80007100:	84ae                	mv	s1,a1
    80007102:	8a32                	mv	s4,a2
    80007104:	89b6                	mv	s3,a3
  struct sock *si, *pos;

  si = 0;
  *f = 0;
    80007106:	00053023          	sd	zero,0(a0)
  if ((*f = filealloc()) == 0)
    8000710a:	ffffd097          	auipc	ra,0xffffd
    8000710e:	4f8080e7          	jalr	1272(ra) # 80004602 <filealloc>
    80007112:	00a93023          	sd	a0,0(s2)
    80007116:	c975                	beqz	a0,8000720a <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    80007118:	ffffa097          	auipc	ra,0xffffa
    8000711c:	860080e7          	jalr	-1952(ra) # 80000978 <kalloc>
    80007120:	8aaa                	mv	s5,a0
    80007122:	c15d                	beqz	a0,800071c8 <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    80007124:	c504                	sw	s1,8(a0)
  si->lport = lport;
    80007126:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    8000712a:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    8000712e:	00003597          	auipc	a1,0x3
    80007132:	aea58593          	addi	a1,a1,-1302 # 80009c18 <userret+0xb88>
    80007136:	0541                	addi	a0,a0,16
    80007138:	ffffa097          	auipc	ra,0xffffa
    8000713c:	8a0080e7          	jalr	-1888(ra) # 800009d8 <initlock>
  mbufq_init(&si->rxq);
    80007140:	030a8513          	addi	a0,s5,48
    80007144:	00000097          	auipc	ra,0x0
    80007148:	a8e080e7          	jalr	-1394(ra) # 80006bd2 <mbufq_init>
  (*f)->type = FD_SOCK;
    8000714c:	00093783          	ld	a5,0(s2)
    80007150:	4711                	li	a4,4
    80007152:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    80007154:	00093703          	ld	a4,0(s2)
    80007158:	4785                	li	a5,1
    8000715a:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    8000715e:	00093703          	ld	a4,0(s2)
    80007162:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    80007166:	00093783          	ld	a5,0(s2)
    8000716a:	0357b423          	sd	s5,40(a5) # f020028 <_entry-0x70fdffd8>

  // add to list of sockets
  acquire(&lock);
    8000716e:	00022517          	auipc	a0,0x22
    80007172:	1b250513          	addi	a0,a0,434 # 80029320 <lock>
    80007176:	ffffa097          	auipc	ra,0xffffa
    8000717a:	936080e7          	jalr	-1738(ra) # 80000aac <acquire>
  pos = sockets;
    8000717e:	00022597          	auipc	a1,0x22
    80007182:	2125b583          	ld	a1,530(a1) # 80029390 <sockets>
  while (pos) {
    80007186:	c9b1                	beqz	a1,800071da <sockalloc+0xee>
  pos = sockets;
    80007188:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    8000718a:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    8000718e:	0009869b          	sext.w	a3,s3
    80007192:	a019                	j	80007198 <sockalloc+0xac>
  pos->rport == rport) {
      release(&lock);
      goto bad;
    }
  ...
  while (pos) {
    80007196:	c3b1                	beqz	a5,800071da <sockalloc+0xee>
    if (pos->raddr == raddr &&
    80007198:	4798                	lw	a4,8(a5)
    8000719a:	fe971de3          	bne	a4,s1,80007194 <sockalloc+0xa8>
    8000719e:	00c7d703          	lhu	a4,12(a5)
    800071a2:	fec719e3          	bne	a4,a2,80007194 <sockalloc+0xa8>
        pos->lport == lport &&
    800071a6:	00e7d703          	lhu	a4,14(a5)
    800071aa:	fed715e3          	bne	a4,a3,80007194 <sockalloc+0xa8>
      release(&lock);
    800071ae:	00022517          	auipc	a0,0x22
    800071b2:	17250513          	addi	a0,a0,370 # 80029320 <lock>
    800071b6:	ffffa097          	auipc	ra,0xffffa
    800071ba:	9c6080e7          	jalr	-1594(ra) # 80000b7c <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    kfree((char*)si);
    800071be:	8556                	mv	a0,s5
    800071c0:	ffff9097          	auipc	ra,0xffff9
    800071c4:	6bc080e7          	jalr	1724(ra) # 8000087c <kfree>
  if (*f)
    800071c8:	00093503          	ld	a0,0(s2)
    800071cc:	c129                	beqz	a0,8000720e <sockalloc+0x122>
    fileclose(*f);
    800071ce:	ffffd097          	auipc	ra,0xffffd
    800071d2:	4f0080e7          	jalr	1264(ra) # 800046be <fileclose>
  return -1;
    800071d6:	557d                	li	a0,-1
    800071d8:	a005                	j	800071f8 <sockalloc+0x10c>
  si->next = sockets;
    800071da:	00bab023          	sd	a1,0(s5)
  sockets = si;
    800071de:	00022797          	auipc	a5,0x22
    800071e2:	1b57b923          	sd	s5,434(a5) # 80029390 <sockets>
  release(&lock);
    800071e6:	00022517          	auipc	a0,0x22
    800071ea:	13a50513          	addi	a0,a0,314 # 80029320 <lock>
    800071ee:	ffffa097          	auipc	ra,0xffffa
    800071f2:	98e080e7          	jalr	-1650(ra) # 80000b7c <release>
  return 0;
    800071f6:	4501                	li	a0,0
}
    800071f8:	70e2                	ld	ra,56(sp)
    800071fa:	7442                	ld	s0,48(sp)
    800071fc:	74a2                	ld	s1,40(sp)
    800071fe:	7902                	ld	s2,32(sp)
    80007200:	69e2                	ld	s3,24(sp)
    80007202:	6a42                	ld	s4,16(sp)
    80007204:	6aa2                	ld	s5,8(sp)
    80007206:	6121                	addi	sp,sp,64
    80007208:	8082                	ret
  return -1;
    8000720a:	557d                	li	a0,-1
    8000720c:	b7f5                	j	800071f8 <sockalloc+0x10c>
    8000720e:	557d                	li	a0,-1
    80007210:	b7e5                	j	800071f8 <sockalloc+0x10c>

0000000080007212 <sockclose>:
...
sockclose(struct sock *si, int writable) {
    80007212:	7179                	addi	sp,sp,-48
    80007214:	f406                	sd	ra,40(sp)
    80007216:	f022                	sd	s0,32(sp)
    80007218:	ec26                	sd	s1,24(sp)
    8000721a:	e84a                	sd	s2,16(sp)
    8000721c:	e44e                	sd	s3,8(sp)
    8000721e:	1800                	addi	s0,sp,48
    80007220:	892a                	mv	s2,a0
  struct sock *pos, *next;
  acquire(&si->lock);
    80007222:	01050993          	addi	s3,a0,16
    80007226:	854e                	mv	a0,s3
    80007228:	ffffa097          	auipc	ra,0xffffa
    8000722c:	884080e7          	jalr	-1916(ra) # 80000aac <acquire>

  // free outstanding mbufs
  while(!mbufq_empty(&si->rxq)) {
    80007230:	03090493          	addi	s1,s2,48
    80007234:	8526                	mv	a0,s1
    80007236:	00000097          	auipc	ra,0x0
    8000723a:	98a080e7          	jalr	-1654(ra) # 80006bc0 <mbufq_empty>
    8000723e:	e919                	bnez	a0,80007254 <sockclose+0x42>
    mbuffree(mbufq_pophead(&si->rxq));
    80007240:	8526                	mv	a0,s1
    80007242:	00000097          	auipc	ra,0x0
    80007246:	968080e7          	jalr	-1688(ra) # 80006baa <mbufq_pophead>
    8000724a:	00000097          	auipc	ra,0x0
    8000724e:	928080e7          	jalr	-1752(ra) # 80006b72 <mbuffree>
    80007252:	b7cd                	j	80007234 <sockclose+0x22>
  }

  // remove from sockets
  acquire(&lock);
    80007254:	00022517          	auipc	a0,0x22
    80007258:	0cc50513          	addi	a0,a0,204 # 80029320 <lock>
    8000725c:	ffffa097          	auipc	ra,0xffffa
    80007260:	850080e7          	jalr	-1968(ra) # 80000aac <acquire>
  pos = sockets;
    80007264:	00022617          	auipc	a2,0x22
    80007268:	12c63603          	ld	a2,300(a2) # 80029390 <sockets>
  if (pos->raddr == si->raddr &&
      pos->lport == si->lport &&
    8000726c:	00893683          	ld	a3,8(s2)
  if (pos->raddr == si->raddr &&
    80007270:	661c                	ld	a5,8(a2)
    80007272:	00d78a63          	beq	a5,a3,80007286 <sockclose+0x74>
  pos->rport == si->rport) {
    sockets = pos->next;
  } else {
    while(pos->next) {
    80007276:	621c                	ld	a5,0(a2)
    80007278:	cf81                	beqz	a5,80007290 <sockclose+0x7e>
      next = pos->next;
      if (next->raddr == si->raddr &&
    8000727a:	6798                	ld	a4,8(a5)
    8000727c:	fee69ee3          	bne	a3,a4,80007278 <sockclose+0x66>
          next->lport == si->lport &&
      next->rport == si->rport) {
        pos->next = next->next;
    80007280:	639c                	ld	a5,0(a5)
    80007282:	e21c                	sd	a5,0(a2)
        break;
    80007284:	a031                	j	80007290 <sockclose+0x7e>
    sockets = pos->next;
    80007286:	621c                	ld	a5,0(a2)
    80007288:	00022717          	auipc	a4,0x22
    8000728c:	10f73423          	sd	a5,264(a4) # 80029390 <sockets>
      }
    }
  }
  release(&lock);
    80007290:	00022517          	auipc	a0,0x22
    80007294:	09050513          	addi	a0,a0,144 # 80029320 <lock>
    80007298:	ffffa097          	auipc	ra,0xffffa
    8000729c:	8e4080e7          	jalr	-1820(ra) # 80000b7c <release>

  // clean up
  release(&si->lock);
    800072a0:	854e                	mv	a0,s3
    800072a2:	ffffa097          	auipc	ra,0xffffa
    800072a6:	8da080e7          	jalr	-1830(ra) # 80000b7c <release>
  kfree((char*)si);
    800072aa:	854a                	mv	a0,s2
    800072ac:	ffff9097          	auipc	ra,0xffff9
    800072b0:	5d0080e7          	jalr	1488(ra) # 8000087c <kfree>
}
    800072b4:	70a2                	ld	ra,40(sp)
    800072b6:	7402                	ld	s0,32(sp)
    800072b8:	64e2                	ld	s1,24(sp)
    800072ba:	6942                	ld	s2,16(sp)
    800072bc:	69a2                	ld	s3,8(sp)
    800072be:	6145                	addi	sp,sp,48
    800072c0:	8082                	ret

00000000800072c2 <sockwrite>:

int
sockwrite(struct sock *si, uint64 addr, int n) {
    800072c2:	7139                	addi	sp,sp,-64
    800072c4:	fc06                	sd	ra,56(sp)
    800072c6:	f822                	sd	s0,48(sp)
    800072c8:	f426                	sd	s1,40(sp)
    800072ca:	f04a                	sd	s2,32(sp)
    800072cc:	ec4e                	sd	s3,24(sp)
    800072ce:	e852                	sd	s4,16(sp)
    800072d0:	e456                	sd	s5,8(sp)
    800072d2:	e05a                	sd	s6,0(sp)
    800072d4:	0080                	addi	s0,sp,64
    800072d6:	84aa                	mv	s1,a0
    800072d8:	8a2e                	mv	s4,a1
    800072da:	8932                	mv	s2,a2
  struct mbuf *m;
  struct proc *pr = myproc();
    800072dc:	ffffa097          	auipc	ra,0xffffa
    800072e0:	7c6080e7          	jalr	1990(ra) # 80001aa2 <myproc>
    800072e4:	8aaa                	mv	s5,a0

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    800072e6:	08000513          	li	a0,128
    800072ea:	00000097          	auipc	ra,0x0
    800072ee:	830080e7          	jalr	-2000(ra) # 80006b1a <mbufalloc>
    800072f2:	89aa                	mv	s3,a0

  acquire(&si->lock);
    800072f4:	01048b13          	addi	s6,s1,16
    800072f8:	855a                	mv	a0,s6
    800072fa:	ffff9097          	auipc	ra,0xffff9
    800072fe:	7b2080e7          	jalr	1970(ra) # 80000aac <acquire>
  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    80007302:	058aba83          	ld	s5,88(s5)
    80007306:	85ca                	mv	a1,s2
    80007308:	854e                	mv	a0,s3
    8000730a:	fffff097          	auipc	ra,0xfffff
    8000730e:	7b4080e7          	jalr	1972(ra) # 80006abe <mbufput>
    80007312:	85aa                	mv	a1,a0
    80007314:	86ca                	mv	a3,s2
    80007316:	8652                	mv	a2,s4
    80007318:	8556                	mv	a0,s5
    8000731a:	ffffa097          	auipc	ra,0xffffa
    8000731e:	508080e7          	jalr	1288(ra) # 80001822 <copyin>
    80007322:	57fd                	li	a5,-1
    80007324:	02f50263          	beq	a0,a5,80007348 <sockwrite+0x86>
    return -1;
  }
  net_tx_udp(m, si->raddr ,si->lport, si->rport);
    80007328:	00e4d683          	lhu	a3,14(s1)
    8000732c:	00c4d603          	lhu	a2,12(s1)
    80007330:	448c                	lw	a1,8(s1)
    80007332:	854e                	mv	a0,s3
    80007334:	00000097          	auipc	ra,0x0
    80007338:	8ae080e7          	jalr	-1874(ra) # 80006be2 <net_tx_udp>
  release(&si->lock);
    8000733c:	855a                	mv	a0,s6
    8000733e:	ffffa097          	auipc	ra,0xffffa
    80007342:	83e080e7          	jalr	-1986(ra) # 80000b7c <release>

  return n;
    80007346:	854a                	mv	a0,s2
}
    80007348:	70e2                	ld	ra,56(sp)
    8000734a:	7442                	ld	s0,48(sp)
    8000734c:	74a2                	ld	s1,40(sp)
    8000734e:	7902                	ld	s2,32(sp)
    80007350:	69e2                	ld	s3,24(sp)
    80007352:	6a42                	ld	s4,16(sp)
    80007354:	6aa2                	ld	s5,8(sp)
    80007356:	6b02                	ld	s6,0(sp)
    80007358:	6121                	addi	sp,sp,64
    8000735a:	8082                	ret

000000008000735c <sockread>:

int
sockread(struct sock *si, uint64 addr, int n) {
    8000735c:	715d                	addi	sp,sp,-80
    8000735e:	e486                	sd	ra,72(sp)
    80007360:	e0a2                	sd	s0,64(sp)
    80007362:	fc26                	sd	s1,56(sp)
    80007364:	f84a                	sd	s2,48(sp)
    80007366:	f44e                	sd	s3,40(sp)
    80007368:	f052                	sd	s4,32(sp)
    8000736a:	ec56                	sd	s5,24(sp)
    8000736c:	e85a                	sd	s6,16(sp)
    8000736e:	e45e                	sd	s7,8(sp)
    80007370:	0880                	addi	s0,sp,80
    80007372:	892a                	mv	s2,a0
    80007374:	89ae                	mv	s3,a1
    80007376:	8ab2                	mv	s5,a2
  struct mbuf *m;
  struct proc *pr = myproc();
    80007378:	ffffa097          	auipc	ra,0xffffa
    8000737c:	72a080e7          	jalr	1834(ra) # 80001aa2 <myproc>
    80007380:	8b2a                	mv	s6,a0
  int i;

  acquire(&si->lock);
    80007382:	01090a13          	addi	s4,s2,16
    80007386:	8552                	mv	a0,s4
    80007388:	ffff9097          	auipc	ra,0xffff9
    8000738c:	724080e7          	jalr	1828(ra) # 80000aac <acquire>
  while(mbufq_empty(&si->rxq)) {
    80007390:	03090913          	addi	s2,s2,48
    80007394:	854a                	mv	a0,s2
    80007396:	00000097          	auipc	ra,0x0
    8000739a:	82a080e7          	jalr	-2006(ra) # 80006bc0 <mbufq_empty>
    8000739e:	84aa                	mv	s1,a0
    800073a0:	c50d                	beqz	a0,800073ca <sockread+0x6e>
    if(myproc()->killed){
    800073a2:	ffffa097          	auipc	ra,0xffffa
    800073a6:	700080e7          	jalr	1792(ra) # 80001aa2 <myproc>
    800073aa:	5d1c                	lw	a5,56(a0)
    800073ac:	eb81                	bnez	a5,800073bc <sockread+0x60>
      release(&si->lock);
      return -1;
    }
    sleep(&si->rxq, &si->lock);
    800073ae:	85d2                	mv	a1,s4
    800073b0:	854a                	mv	a0,s2
    800073b2:	ffffb097          	auipc	ra,0xffffb
    800073b6:	eac080e7          	jalr	-340(ra) # 8000225e <sleep>
    800073ba:	bfe9                	j	80007394 <sockread+0x38>
      release(&si->lock);
    800073bc:	8552                	mv	a0,s4
    800073be:	ffff9097          	auipc	ra,0xffff9
    800073c2:	7be080e7          	jalr	1982(ra) # 80000b7c <release>
      return -1;
    800073c6:	54fd                	li	s1,-1
    800073c8:	a0a9                	j	80007412 <sockread+0xb6>
  }
  m = mbufq_pophead(&si->rxq);
    800073ca:	854a                	mv	a0,s2
    800073cc:	fffff097          	auipc	ra,0xfffff
    800073d0:	7de080e7          	jalr	2014(ra) # 80006baa <mbufq_pophead>
    800073d4:	892a                	mv	s2,a0
  for(i = 0; i < n; i++){
    800073d6:	03505963          	blez	s5,80007408 <sockread+0xac>
    if(copyout(pr->pagetable, addr + i, m->head, 1) == -1)
    800073da:	5bfd                	li	s7,-1
    800073dc:	4685                	li	a3,1
    800073de:	00893603          	ld	a2,8(s2)
    800073e2:	85ce                	mv	a1,s3
    800073e4:	058b3503          	ld	a0,88(s6)
    800073e8:	ffffa097          	auipc	ra,0xffffa
    800073ec:	3ae080e7          	jalr	942(ra) # 80001796 <copyout>
    800073f0:	01750c63          	beq	a0,s7,80007408 <sockread+0xac>
      break;
    mbufpull(m, 1);
    800073f4:	4585                	li	a1,1
    800073f6:	854a                	mv	a0,s2
    800073f8:	fffff097          	auipc	ra,0xfffff
    800073fc:	5f2080e7          	jalr	1522(ra) # 800069ea <mbufpull>
  for(i = 0; i < n; i++){
    80007400:	2485                	addiw	s1,s1,1
    80007402:	0985                	addi	s3,s3,1
    80007404:	fc9a9ce3          	bne	s5,s1,800073dc <sockread+0x80>
  }
  release(&si->lock);
    80007408:	8552                	mv	a0,s4
    8000740a:	ffff9097          	auipc	ra,0xffff9
    8000740e:	772080e7          	jalr	1906(ra) # 80000b7c <release>
  return i;
}
    80007412:	8526                	mv	a0,s1
    80007414:	60a6                	ld	ra,72(sp)
    80007416:	6406                	ld	s0,64(sp)
    80007418:	74e2                	ld	s1,56(sp)
    8000741a:	7942                	ld	s2,48(sp)
    8000741c:	79a2                	ld	s3,40(sp)
    8000741e:	7a02                	ld	s4,32(sp)
    80007420:	6ae2                	ld	s5,24(sp)
    80007422:	6b42                	ld	s6,16(sp)
    80007424:	6ba2                	ld	s7,8(sp)
    80007426:	6161                	addi	sp,sp,80
    80007428:	8082                	ret

000000008000742a <sockrecvudp>:

// called by protocol handler layer to deliver UDP packets
void
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    8000742a:	7139                	addi	sp,sp,-64
    8000742c:	fc06                	sd	ra,56(sp)
    8000742e:	f822                	sd	s0,48(sp)
    80007430:	f426                	sd	s1,40(sp)
    80007432:	f04a                	sd	s2,32(sp)
    80007434:	ec4e                	sd	s3,24(sp)
    80007436:	e852                	sd	s4,16(sp)
    80007438:	e456                	sd	s5,8(sp)
    8000743a:	0080                	addi	s0,sp,64
    8000743c:	8a2a                	mv	s4,a0
    8000743e:	892e                	mv	s2,a1
    80007440:	89b2                	mv	s3,a2
    80007442:	8ab6                	mv	s5,a3
  ...
  struct sock *si;
  acquire(&lock);
    80007444:	00022517          	auipc	a0,0x22
    80007448:	edc50513          	addi	a0,a0,-292 # 80029320 <lock>
    8000744c:	ffff9097          	auipc	ra,0xffff9
    80007450:	660080e7          	jalr	1632(ra) # 80000aac <acquire>
  si = sockets;
    80007454:	00022497          	auipc	s1,0x22
    80007458:	f3c4b483          	ld	s1,-196(s1) # 80029390 <sockets>
  while(si) {
    8000745c:	ccad                	beqz	s1,800074d6 <sockrecvudp+0xac>
    if (si->raddr == raddr &&
    8000745e:	0009871b          	sext.w	a4,s3
        si->lport == lport &&
    80007462:	000a869b          	sext.w	a3,s5
    80007466:	a019                	j	8000746c <sockrecvudp+0x42>
  si->rport == rport) {
      release(&lock);
      break;
    }
  ...
  while(si) {
    8000746a:	c4b5                	beqz	s1,800074d6 <sockrecvudp+0xac>
    if (si->raddr == raddr &&
    8000746c:	449c                	lw	a5,8(s1)
    8000746e:	ff279de3          	bne	a5,s2,80007468 <sockrecvudp+0x3e>
    80007472:	00c4d783          	lhu	a5,12(s1)
    80007476:	fee799e3          	bne	a5,a4,80007468 <sockrecvudp+0x3e>
        si->lport == lport &&
    8000747a:	00e4d783          	lhu	a5,14(s1)
    8000747e:	fed795e3          	bne	a5,a3,80007468 <sockrecvudp+0x3e>
      release(&lock);
    80007482:	00022517          	auipc	a0,0x22
    80007486:	e9e50513          	addi	a0,a0,-354 # 80029320 <lock>
    8000748a:	ffff9097          	auipc	ra,0xffff9
    8000748e:	6f2080e7          	jalr	1778(ra) # 80000b7c <release>
  }
  if (!si) {
    release(&lock);
  }
  if (si) {
    acquire(&si->lock);
    80007492:	01048913          	addi	s2,s1,16
    80007496:	854a                	mv	a0,s2
    80007498:	ffff9097          	auipc	ra,0xffff9
    8000749c:	614080e7          	jalr	1556(ra) # 80000aac <acquire>
    mbufq_pushtail(&si->rxq, m);
    800074a0:	03048493          	addi	s1,s1,48
    800074a4:	85d2                	mv	a1,s4
    800074a6:	8526                	mv	a0,s1
    800074a8:	fffff097          	auipc	ra,0xfffff
    800074ac:	6e2080e7          	jalr	1762(ra) # 80006b8a <mbufq_pushtail>
    release(&si->lock);
    800074b0:	854a                	mv	a0,s2
    800074b2:	ffff9097          	auipc	ra,0xffff9
    800074b6:	6ca080e7          	jalr	1738(ra) # 80000b7c <release>
    wakeup(&si->rxq);
    800074ba:	8526                	mv	a0,s1
    800074bc:	ffffb097          	auipc	ra,0xffffb
    800074c0:	f28080e7          	jalr	-216(ra) # 800023e4 <wakeup>
  } else {
    mbuffree(m);
  }
}
    800074c4:	70e2                	ld	ra,56(sp)
    800074c6:	7442                	ld	s0,48(sp)
    800074c8:	74a2                	ld	s1,40(sp)
    800074ca:	7902                	ld	s2,32(sp)
    800074cc:	69e2                	ld	s3,24(sp)
    800074ce:	6a42                	ld	s4,16(sp)
    800074d0:	6aa2                	ld	s5,8(sp)
    800074d2:	6121                	addi	sp,sp,64
    800074d4:	8082                	ret
    release(&lock);
    800074d6:	00022517          	auipc	a0,0x22
    800074da:	e4a50513          	addi	a0,a0,-438 # 80029320 <lock>
    800074de:	ffff9097          	auipc	ra,0xffff9
    800074e2:	69e080e7          	jalr	1694(ra) # 80000b7c <release>
    mbuffree(m);
    800074e6:	8552                	mv	a0,s4
    800074e8:	fffff097          	auipc	ra,0xfffff
    800074ec:	68a080e7          	jalr	1674(ra) # 80006b72 <mbuffree>
    800074f0:	bfd1                	j	800074c4 <sockrecvudp+0x9a>

00000000800074f2 <pci_init>:
#include "proc.h"
#include "defs.h"
...
pci_init()
{
    800074f2:	715d                	addi	sp,sp,-80
    800074f4:	e486                	sd	ra,72(sp)
    800074f6:	e0a2                	sd	s0,64(sp)
    800074f8:	fc26                	sd	s1,56(sp)
    800074fa:	f84a                	sd	s2,48(sp)
    800074fc:	f44e                	sd	s3,40(sp)
    800074fe:	f052                	sd	s4,32(sp)
    80007500:	ec56                	sd	s5,24(sp)
    80007502:	e85a                	sd	s6,16(sp)
    80007504:	e45e                	sd	s7,8(sp)
    80007506:	0880                	addi	s0,sp,80
    80007508:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    8000750c:	100e8937          	lui	s2,0x100e8
    80007510:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    80007514:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    80007516:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    80007518:	40000b37          	lui	s6,0x40000
    8000751c:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    8000751e:	300409b7          	lui	s3,0x30040
    80007522:	a819                	j	80007538 <pci_init+0x46>
      base[4+0] = e1000_regs;
    80007524:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    80007528:	855a                	mv	a0,s6
    8000752a:	fffff097          	auipc	ra,0xfffff
    8000752e:	0da080e7          	jalr	218(ra) # 80006604 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    80007532:	94d2                	add	s1,s1,s4
    80007534:	03348a63          	beq	s1,s3,80007568 <pci_init+0x76>
    volatile uint32 *base = ecam + off;
    80007538:	86a6                	mv	a3,s1
    uint32 id = base[0];
    8000753a:	409c                	lw	a5,0(s1)
    8000753c:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    8000753e:	ff279ae3          	bne	a5,s2,80007532 <pci_init+0x40>
      base[1] = 7;
    80007542:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    80007546:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    8000754a:	01048793          	addi	a5,s1,16
    8000754e:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    80007552:	4398                	lw	a4,0(a5)
    80007554:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    80007556:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    8000755a:	0ff0000f          	fence
        base[4+i] = old;
    8000755e:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    80007560:	0791                	addi	a5,a5,4
    80007562:	fec798e3          	bne	a5,a2,80007552 <pci_init+0x60>
    80007566:	bf7d                	j	80007524 <pci_init+0x32>
    }
  }
}
    80007568:	60a6                	ld	ra,72(sp)
    8000756a:	6406                	ld	s0,64(sp)
    8000756c:	74e2                	ld	s1,56(sp)
    8000756e:	7942                	ld	s2,48(sp)
    80007570:	79a2                	ld	s3,40(sp)
    80007572:	7a02                	ld	s4,32(sp)
    80007574:	6ae2                	ld	s5,24(sp)
    80007576:	6b42                	ld	s6,16(sp)
    80007578:	6ba2                	ld	s7,8(sp)
    8000757a:	6161                	addi	sp,sp,80
    8000757c:	8082                	ret

000000008000757e <bit_isset>:
...
int bit_isset(char *array, int index) {
  ...
  char m = (1 << (index % 8));
    80007584:	41f5d79b          	sraiw	a5,a1,0x1f
    80007588:	01d7d79b          	srliw	a5,a5,0x1d
    8000758c:	9dbd                	addw	a1,a1,a5
    8000758e:	0075f713          	andi	a4,a1,7
    80007592:	9f1d                	subw	a4,a4,a5
    80007594:	4785                	li	a5,1
    80007596:	00e797bb          	sllw	a5,a5,a4
  char b = array[index/8];
    8000759a:	4035d59b          	sraiw	a1,a1,0x3
    8000759e:	95aa                	add	a1,a1,a0
  return (b & m) == m;
    800075a0:	0005c503          	lbu	a0,0(a1)
    800075a4:	8d7d                	and	a0,a0,a5
    800075a6:	0ff7f793          	andi	a5,a5,255
    800075aa:	8d1d                	sub	a0,a0,a5
}
    800075ac:	00153513          	seqz	a0,a0
    800075b0:	6422                	ld	s0,8(sp)
    800075b2:	0141                	addi	sp,sp,16
    800075b4:	8082                	ret

00000000800075b6 <bit_set>:

// Set bit at position index in array to 1
void bit_set(char *array, int index) {
    800075b6:	1141                	addi	sp,sp,-16
    800075b8:	e422                	sd	s0,8(sp)
    800075ba:	0800                	addi	s0,sp,16
  char b = array[index/8];
    800075bc:	41f5d79b          	sraiw	a5,a1,0x1f
    800075c0:	01d7d79b          	srliw	a5,a5,0x1d
    800075c4:	9dbd                	addw	a1,a1,a5
    800075c6:	4035d71b          	sraiw	a4,a1,0x3
    800075ca:	953a                	add	a0,a0,a4
  char m = (1 << (index % 8));
    800075cc:	899d                	andi	a1,a1,7
    800075ce:	9d9d                	subw	a1,a1,a5
  array[index/8] = (b | m);
    800075d0:	4785                	li	a5,1
    800075d2:	00b795bb          	sllw	a1,a5,a1
    800075d6:	00054783          	lbu	a5,0(a0)
    800075da:	8ddd                	or	a1,a1,a5
...
00000000800075e6 <bit_clear>:

// Clear bit at position index in array
void bit_clear(char *array, int index) {
    800075e6:	1141                	addi	sp,sp,-16
    800075e8:	e422                	sd	s0,8(sp)
    800075ea:	0800                	addi	s0,sp,16
  char b = array[index/8];
    800075ec:	41f5d79b          	sraiw	a5,a1,0x1f
    800075f0:	01d7d79b          	srliw	a5,a5,0x1d
    800075f4:	9dbd                	addw	a1,a1,a5
    800075f6:	4035d71b          	sraiw	a4,a1,0x3
    800075fa:	953a                	add	a0,a0,a4
  char m = (1 << (index % 8));
    800075fc:	899d                	andi	a1,a1,7
    800075fe:	9d9d                	subw	a1,a1,a5
  array[index/8] = (b & ~m);
    80007600:	4785                	li	a5,1
    80007602:	00b795bb          	sllw	a1,a5,a1
    80007606:	fff5c593          	not	a1,a1
    8000760a:	00054783          	lbu	a5,0(a0)
    8000760e:	8dfd                	and	a1,a1,a5
    80007610:	00b50023          	sb	a1,0(a0)
}
    80007614:	6422                	ld	s0,8(sp)
    80007616:	0141                	addi	sp,sp,16
    80007618:	8082                	ret

000000008000761a <bd_print_vector>:

// Print a bit vector as a list of ranges of 1 bits
void
bd_print_vector(char *vector, int len) {
    8000761a:	715d                	addi	sp,sp,-80
    8000761c:	e486                	sd	ra,72(sp)
    8000761e:	e0a2                	sd	s0,64(sp)
    80007620:	fc26                	sd	s1,56(sp)
    80007622:	f84a                	sd	s2,48(sp)
    80007624:	f44e                	sd	s3,40(sp)
    80007626:	f052                	sd	s4,32(sp)
    80007628:	ec56                	sd	s5,24(sp)
    8000762a:	e85a                	sd	s6,16(sp)
    8000762c:	e45e                	sd	s7,8(sp)
    8000762e:	0880                	addi	s0,sp,80
    80007630:	8a2e                	mv	s4,a1
  int last, lb;
  
  last = 1;
  lb = 0;
  for (int b = 0; b < len; b++) {
    80007632:	08b05b63          	blez	a1,800076c8 <bd_print_vector+0xae>
    80007636:	89aa                	mv	s3,a0
    80007638:	4481                	li	s1,0
  lb = 0;
    8000763a:	4a81                	li	s5,0
  last = 1;
    8000763c:	4905                	li	s2,1
    if (last == bit_isset(vector, b))
      continue;
    if(last == 1)
    8000763e:	4b05                	li	s6,1
      printf(" [%d, %d)", lb, b);
    80007640:	00002b97          	auipc	s7,0x2
    80007644:	5e0b8b93          	addi	s7,s7,1504 # 80009c20 <userret+0xb90>
    80007648:	a01d                	j	8000766e <bd_print_vector+0x54>
    8000764a:	8626                	mv	a2,s1
    8000764c:	85d6                	mv	a1,s5
    8000764e:	855e                	mv	a0,s7
    80007650:	ffff9097          	auipc	ra,0xffff9
    80007654:	f64080e7          	jalr	-156(ra) # 800005b4 <printf>
    lb = b;
    last = bit_isset(vector, b);
    80007658:	85a6                	mv	a1,s1
    8000765a:	854e                	mv	a0,s3
    8000765c:	00000097          	auipc	ra,0x0
    80007660:	f22080e7          	jalr	-222(ra) # 8000757e <bit_isset>
    80007664:	892a                	mv	s2,a0
    80007666:	8aa6                	mv	s5,s1
  for (int b = 0; b < len; b++) {
    80007668:	2485                	addiw	s1,s1,1
    8000766a:	009a0d63          	beq	s4,s1,80007684 <bd_print_vector+0x6a>
    if (last == bit_isset(vector, b))
    8000766e:	85a6                	mv	a1,s1
    80007670:	854e                	mv	a0,s3
    80007672:	00000097          	auipc	ra,0x0
    80007676:	f0c080e7          	jalr	-244(ra) # 8000757e <bit_isset>
    8000767a:	ff2507e3          	beq	a0,s2,80007668 <bd_print_vector+0x4e>
    if(last == 1)
    8000767e:	fd691de3          	bne	s2,s6,80007658 <bd_print_vector+0x3e>
    80007682:	b7e1                	j	8000764a <bd_print_vector+0x30>
  }
  if(lb == 0 || last == 1) {
    80007684:	000a8563          	beqz	s5,8000768e <bd_print_vector+0x74>
    80007688:	4785                	li	a5,1
    8000768a:	00f91c63          	bne	s2,a5,800076a2 <bd_print_vector+0x88>
    printf(" [%d, %d)", lb, len);
    8000768e:	8652                	mv	a2,s4
    80007690:	85d6                	mv	a1,s5
    80007692:	00002517          	auipc	a0,0x2
    80007696:	58e50513          	addi	a0,a0,1422 # 80009c20 <userret+0xb90>
    8000769a:	ffff9097          	auipc	ra,0xffff9
    8000769e:	f1a080e7          	jalr	-230(ra) # 800005b4 <printf>
  }
  printf("\n");
    800076a2:	00002517          	auipc	a0,0x2
    800076a6:	bee50513          	addi	a0,a0,-1042 # 80009290 <userret+0x200>
    800076aa:	ffff9097          	auipc	ra,0xffff9
    800076ae:	f0a080e7          	jalr	-246(ra) # 800005b4 <printf>
}
    800076b2:	60a6                	ld	ra,72(sp)
    800076b4:	6406                	ld	s0,64(sp)
    800076b6:	74e2                	ld	s1,56(sp)
    800076b8:	7942                	ld	s2,48(sp)
    800076ba:	79a2                	ld	s3,40(sp)
    800076bc:	7a02                	ld	s4,32(sp)
    800076be:	6ae2                	ld	s5,24(sp)
    800076c0:	6b42                	ld	s6,16(sp)
    800076c2:	6ba2                	ld	s7,8(sp)
    800076c4:	6161                	addi	sp,sp,80
    800076c6:	8082                	ret
  lb = 0;
    800076c8:	4a81                	li	s5,0
    800076ca:	b7d1                	j	8000768e <bd_print_vector+0x74>

00000000800076cc <bd_print>:

// Print buddy's data structures
void
bd_print() {
  for (int k = 0; k < nsizes; k++) {
    800076cc:	00022697          	auipc	a3,0x22
    800076d0:	cdc6a683          	lw	a3,-804(a3) # 800293a8 <nsizes>
    800076d4:	10d05063          	blez	a3,800077d4 <bd_print+0x108>
bd_print() {
    800076d8:	711d                	addi	sp,sp,-96
    800076da:	ec86                	sd	ra,88(sp)
    800076dc:	e8a2                	sd	s0,80(sp)
    800076de:	e4a6                	sd	s1,72(sp)
    800076e0:	e0ca                	sd	s2,64(sp)
    800076e2:	fc4e                	sd	s3,56(sp)
    800076e4:	f852                	sd	s4,48(sp)
    800076e6:	f456                	sd	s5,40(sp)
    800076e8:	f05a                	sd	s6,32(sp)
    800076ea:	ec5e                	sd	s7,24(sp)
    800076ec:	e862                	sd	s8,16(sp)
    800076ee:	e466                	sd	s9,8(sp)
    800076f0:	e06a                	sd	s10,0(sp)
    800076f2:	1080                	addi	s0,sp,96
  for (int k = 0; k < nsizes; k++) {
    800076f4:	4481                	li	s1,0
    printf("size %d (blksz %d nblk %d): free list: ", k, BLK_SIZE(k), NBLK(k));
    800076f6:	4a85                	li	s5,1
    800076f8:	4c41                	li	s8,16
    800076fa:	00002b97          	auipc	s7,0x2
    800076fe:	536b8b93          	addi	s7,s7,1334 # 80009c30 <userret+0xba0>
    lst_print(&bd_sizes[k].free);
    80007702:	00022a17          	auipc	s4,0x22
    80007706:	c9ea0a13          	addi	s4,s4,-866 # 800293a0 <bd_sizes>
    printf("  alloc:");
    8000770a:	00002b17          	auipc	s6,0x2
    8000770e:	54eb0b13          	addi	s6,s6,1358 # 80009c58 <userret+0xbc8>
    bd_print_vector(bd_sizes[k].alloc, NBLK(k));
    80007712:	00022997          	auipc	s3,0x22
    80007716:	c9698993          	addi	s3,s3,-874 # 800293a8 <nsizes>
    if(k > 0) {
      printf("  split:");
    8000771a:	00002c97          	auipc	s9,0x2
    8000771e:	54ec8c93          	addi	s9,s9,1358 # 80009c68 <userret+0xbd8>
    80007722:	a801                	j	80007732 <bd_print+0x66>
  for (int k = 0; k < nsizes; k++) {
    80007724:	0009a683          	lw	a3,0(s3)
    80007728:	0485                	addi	s1,s1,1
    8000772a:	0004879b          	sext.w	a5,s1
    8000772e:	08d7d563          	bge	a5,a3,800077b8 <bd_print+0xec>
    80007732:	0004891b          	sext.w	s2,s1
    printf("size %d (blksz %d nblk %d): free list: ", k, BLK_SIZE(k), NBLK(k));
    80007736:	36fd                	addiw	a3,a3,-1
    80007738:	9e85                	subw	a3,a3,s1
    8000773a:	00da96bb          	sllw	a3,s5,a3
    8000773e:	009c1633          	sll	a2,s8,s1
    80007742:	85ca                	mv	a1,s2
    80007744:	855e                	mv	a0,s7
    80007746:	ffff9097          	auipc	ra,0xffff9
    8000774a:	e6e080e7          	jalr	-402(ra) # 800005b4 <printf>
    lst_print(&bd_sizes[k].free);
    8000774e:	00549d13          	slli	s10,s1,0x5
    80007752:	000a3503          	ld	a0,0(s4)
    80007756:	956a                	add	a0,a0,s10
    80007758:	00001097          	auipc	ra,0x1
    8000775c:	a4e080e7          	jalr	-1458(ra) # 800081a6 <lst_print>
    printf("  alloc:");
    80007760:	855a                	mv	a0,s6
    80007762:	ffff9097          	auipc	ra,0xffff9
    80007766:	e52080e7          	jalr	-430(ra) # 800005b4 <printf>
    bd_print_vector(bd_sizes[k].alloc, NBLK(k));
    8000776a:	0009a583          	lw	a1,0(s3)
    8000776e:	35fd                	addiw	a1,a1,-1
    80007770:	412585bb          	subw	a1,a1,s2
    80007774:	000a3783          	ld	a5,0(s4)
    80007778:	97ea                	add	a5,a5,s10
    8000777a:	00ba95bb          	sllw	a1,s5,a1
    8000777e:	6b88                	ld	a0,16(a5)
    80007780:	00000097          	auipc	ra,0x0
    80007784:	e9a080e7          	jalr	-358(ra) # 8000761a <bd_print_vector>
    if(k > 0) {
    80007788:	f9205ee3          	blez	s2,80007724 <bd_print+0x58>
      printf("  split:");
    8000778c:	8566                	mv	a0,s9
    8000778e:	ffff9097          	auipc	ra,0xffff9
    80007792:	e26080e7          	jalr	-474(ra) # 800005b4 <printf>
      bd_print_vector(bd_sizes[k].split, NBLK(k));
    80007796:	0009a583          	lw	a1,0(s3)
    8000779a:	35fd                	addiw	a1,a1,-1
    8000779c:	412585bb          	subw	a1,a1,s2
    800077a0:	000a3783          	ld	a5,0(s4)
    800077a4:	9d3e                	add	s10,s10,a5
    800077a6:	00ba95bb          	sllw	a1,s5,a1
    800077aa:	018d3503          	ld	a0,24(s10)
    800077ae:	00000097          	auipc	ra,0x0
    800077b2:	e6c080e7          	jalr	-404(ra) # 8000761a <bd_print_vector>
    800077b6:	b7bd                	j	80007724 <bd_print+0x58>
    }
  }
}
    800077b8:	60e6                	ld	ra,88(sp)
    800077ba:	6446                	ld	s0,80(sp)
    800077bc:	64a6                	ld	s1,72(sp)
    800077be:	6906                	ld	s2,64(sp)
    800077c0:	79e2                	ld	s3,56(sp)
    800077c2:	7a42                	ld	s4,48(sp)
    800077c4:	7aa2                	ld	s5,40(sp)
    800077c6:	7b02                	ld	s6,32(sp)
    800077c8:	6be2                	ld	s7,24(sp)
    800077ca:	6c42                	ld	s8,16(sp)
    800077cc:	6ca2                	ld	s9,8(sp)
    800077ce:	6d02                	ld	s10,0(sp)
    800077d0:	6125                	addi	sp,sp,96
    800077d2:	8082                	ret
    800077d4:	8082                	ret

00000000800077d6 <firstk>:

// What is the first k such that 2^k >= n?
int
firstk(uint64 n) {
    800077d6:	1141                	addi	sp,sp,-16
    800077d8:	e422                	sd	s0,8(sp)
    800077da:	0800                	addi	s0,sp,16
  int k = 0;
  uint64 size = LEAF_SIZE;

  while (size < n) {
    800077dc:	47c1                	li	a5,16
    800077de:	00a7fb63          	bgeu	a5,a0,800077f4 <firstk+0x1e>
    800077e2:	872a                	mv	a4,a0
  int k = 0;
    800077e4:	4501                	li	a0,0
    k++;
    800077e6:	2505                	addiw	a0,a0,1
    size *= 2;
    800077e8:	0786                	slli	a5,a5,0x1
  while (size < n) {
    800077ea:	fee7eee3          	bltu	a5,a4,800077e6 <firstk+0x10>
  }
  return k;
}
    800077ee:	6422                	ld	s0,8(sp)
    800077f0:	0141                	addi	sp,sp,16
    800077f2:	8082                	ret
  int k = 0;
    800077f4:	4501                	li	a0,0
    800077f6:	bfe5                	j	800077ee <firstk+0x18>

00000000800077f8 <blk_index>:
...
blk_index(int k, char *p) {
  ...
  return n / BLK_SIZE(k);
    800077fe:	00022797          	auipc	a5,0x22
    80007802:	b9a7b783          	ld	a5,-1126(a5) # 80029398 <bd_base>
    80007806:	9d9d                	subw	a1,a1,a5
    80007808:	47c1                	li	a5,16
    8000780a:	00a79533          	sll	a0,a5,a0
    8000780e:	02a5c533          	div	a0,a1,a0
}
    80007812:	2501                	sext.w	a0,a0
    80007814:	6422                	ld	s0,8(sp)
    80007816:	0141                	addi	sp,sp,16
    80007818:	8082                	ret

000000008000781a <addr>:

// Convert a block index at size k back into an address
void *addr(int k, int bi) {
    8000781a:	1141                	addi	sp,sp,-16
    8000781c:	e422                	sd	s0,8(sp)
    8000781e:	0800                	addi	s0,sp,16
  int n = bi * BLK_SIZE(k);
    80007820:	47c1                	li	a5,16
    80007822:	00a797b3          	sll	a5,a5,a0
  return (char *) bd_base + n;
    80007826:	02b787bb          	mulw	a5,a5,a1
}
    8000782a:	00022517          	auipc	a0,0x22
    8000782e:	b6e53503          	ld	a0,-1170(a0) # 80029398 <bd_base>
    80007832:	953e                	add	a0,a0,a5
    80007834:	6422                	ld	s0,8(sp)
    80007836:	0141                	addi	sp,sp,16
    80007838:	8082                	ret

000000008000783a <bd_malloc>:

// allocate nbytes, but malloc won't return anything smaller than LEAF_SIZE
void *
bd_malloc(uint64 nbytes)
{
    8000783a:	7159                	addi	sp,sp,-112
    8000783c:	f486                	sd	ra,104(sp)
    8000783e:	f0a2                	sd	s0,96(sp)
    80007840:	eca6                	sd	s1,88(sp)
    80007842:	e8ca                	sd	s2,80(sp)
    80007844:	e4ce                	sd	s3,72(sp)
    80007846:	e0d2                	sd	s4,64(sp)
    80007848:	fc56                	sd	s5,56(sp)
    8000784a:	f85a                	sd	s6,48(sp)
    8000784c:	f45e                	sd	s7,40(sp)
    8000784e:	f062                	sd	s8,32(sp)
    80007850:	ec66                	sd	s9,24(sp)
    80007852:	e86a                	sd	s10,16(sp)
    80007854:	e46e                	sd	s11,8(sp)
    80007856:	1880                	addi	s0,sp,112
    80007858:	84aa                	mv	s1,a0
  int fk, k;

  acquire(&lock);
    8000785a:	00022517          	auipc	a0,0x22
    8000785e:	ae650513          	addi	a0,a0,-1306 # 80029340 <lock>
    80007862:	ffff9097          	auipc	ra,0xffff9
    80007866:	24a080e7          	jalr	586(ra) # 80000aac <acquire>

  // Find a free block >= nbytes, starting with smallest k possible
  fk = firstk(nbytes);
    8000786a:	8526                	mv	a0,s1
    8000786c:	00000097          	auipc	ra,0x0
    80007870:	f6a080e7          	jalr	-150(ra) # 800077d6 <firstk>
  for (k = fk; k < nsizes; k++) {
    80007874:	00022797          	auipc	a5,0x22
    80007878:	b347a783          	lw	a5,-1228(a5) # 800293a8 <nsizes>
    8000787c:	02f55d63          	bge	a0,a5,800078b6 <bd_malloc+0x7c>
    80007880:	8c2a                	mv	s8,a0
    80007882:	00551913          	slli	s2,a0,0x5
    80007886:	84aa                	mv	s1,a0
    if(!lst_empty(&bd_sizes[k].free))
    80007888:	00022997          	auipc	s3,0x22
    8000788c:	b1898993          	addi	s3,s3,-1256 # 800293a0 <bd_sizes>
  for (k = fk; k < nsizes; k++) {
    80007890:	00022a17          	auipc	s4,0x22
    80007894:	b18a0a13          	addi	s4,s4,-1256 # 800293a8 <nsizes>
    if(!lst_empty(&bd_sizes[k].free))
    80007898:	0009b503          	ld	a0,0(s3)
    8000789c:	954a                	add	a0,a0,s2
    8000789e:	00001097          	auipc	ra,0x1
    800078a2:	88e080e7          	jalr	-1906(ra) # 8000812c <lst_empty>
    800078a6:	c115                	beqz	a0,800078ca <bd_malloc+0x90>
  for (k = fk; k < nsizes; k++) {
    800078a8:	2485                	addiw	s1,s1,1
    800078aa:	02090913          	addi	s2,s2,32
    800078ae:	000a2783          	lw	a5,0(s4)
    800078b2:	fef4c3e3          	blt	s1,a5,80007898 <bd_malloc+0x5e>
      break;
  }
  if(k >= nsizes) { // No free blocks?
    release(&lock);
    800078b6:	00022517          	auipc	a0,0x22
    800078ba:	a8a50513          	addi	a0,a0,-1398 # 80029340 <lock>
    800078be:	ffff9097          	auipc	ra,0xffff9
    800078c2:	2be080e7          	jalr	702(ra) # 80000b7c <release>
    return 0;
    800078c6:	4b01                	li	s6,0
    800078c8:	a0e1                	j	80007990 <bd_malloc+0x156>
  if(k >= nsizes) { // No free blocks?
    800078ca:	00022797          	auipc	a5,0x22
    800078ce:	ade7a783          	lw	a5,-1314(a5) # 800293a8 <nsizes>
    800078d2:	fef4d2e3          	bge	s1,a5,800078b6 <bd_malloc+0x7c>
  }

  // Found a block; pop it and potentially split it.
  char *p = lst_pop(&bd_sizes[k].free);
    800078d6:	00549993          	slli	s3,s1,0x5
    800078da:	00022917          	auipc	s2,0x22
    800078de:	ac690913          	addi	s2,s2,-1338 # 800293a0 <bd_sizes>
    800078e2:	00093503          	ld	a0,0(s2)
    800078e6:	954e                	add	a0,a0,s3
    800078e8:	00001097          	auipc	ra,0x1
    800078ec:	870080e7          	jalr	-1936(ra) # 80008158 <lst_pop>
    800078f0:	8b2a                	mv	s6,a0
  return n / BLK_SIZE(k);
    800078f2:	00022597          	auipc	a1,0x22
    800078f6:	aa65b583          	ld	a1,-1370(a1) # 80029398 <bd_base>
    800078fa:	40b505bb          	subw	a1,a0,a1
    800078fe:	47c1                	li	a5,16
    80007900:	009797b3          	sll	a5,a5,s1
    80007904:	02f5c5b3          	div	a1,a1,a5
  bit_set(bd_sizes[k].alloc, blk_index(k, p));
    80007908:	00093783          	ld	a5,0(s2)
    8000790c:	97ce                	add	a5,a5,s3
    8000790e:	2581                	sext.w	a1,a1
    80007910:	6b88                	ld	a0,16(a5)
    80007912:	00000097          	auipc	ra,0x0
    80007916:	ca4080e7          	jalr	-860(ra) # 800075b6 <bit_set>
  for(; k > fk; k--) {
    8000791a:	069c5363          	bge	s8,s1,80007980 <bd_malloc+0x146>
    // split a block at size k and mark one half allocated at size k-1
    // and put the buddy on the free list at size k-1
    char *q = p + BLK_SIZE(k-1);   // p's buddy
    8000791e:	4bc1                	li	s7,16
    bit_set(bd_sizes[k].split, blk_index(k, p));
    80007920:	8dca                	mv	s11,s2
  int n = p - (char *) bd_base;
    80007922:	00022d17          	auipc	s10,0x22
    80007926:	a76d0d13          	addi	s10,s10,-1418 # 80029398 <bd_base>
    char *q = p + BLK_SIZE(k-1);   // p's buddy
    8000792a:	85a6                	mv	a1,s1
    8000792c:	34fd                	addiw	s1,s1,-1
    8000792e:	009b9ab3          	sll	s5,s7,s1
    80007932:	015b0cb3          	add	s9,s6,s5
    bit_set(bd_sizes[k].split, blk_index(k, p));
    80007936:	000dba03          	ld	s4,0(s11)
  int n = p - (char *) bd_base;
    8000793a:	000d3903          	ld	s2,0(s10)
  return n / BLK_SIZE(k);
    8000793e:	412b093b          	subw	s2,s6,s2
    80007942:	00bb95b3          	sll	a1,s7,a1
    80007946:	02b945b3          	div	a1,s2,a1
    bit_set(bd_sizes[k].split, blk_index(k, p));
    8000794a:	013a07b3          	add	a5,s4,s3
    8000794e:	2581                	sext.w	a1,a1
    80007950:	6f88                	ld	a0,24(a5)
    80007952:	00000097          	auipc	ra,0x0
    80007956:	c64080e7          	jalr	-924(ra) # 800075b6 <bit_set>
    bit_set(bd_sizes[k-1].alloc, blk_index(k-1, p));
    8000795a:	1981                	addi	s3,s3,-32
    8000795c:	9a4e                	add	s4,s4,s3
  return n / BLK_SIZE(k);
    8000795e:	035945b3          	div	a1,s2,s5
    bit_set(bd_sizes[k-1].alloc, blk_index(k-1, p));
    80007962:	2581                	sext.w	a1,a1
    80007964:	010a3503          	ld	a0,16(s4)
    80007968:	00000097          	auipc	ra,0x0
    8000796c:	c4e080e7          	jalr	-946(ra) # 800075b6 <bit_set>
    lst_push(&bd_sizes[k-1].free, q);
    80007970:	85e6                	mv	a1,s9
    80007972:	8552                	mv	a0,s4
    80007974:	00001097          	auipc	ra,0x1
    80007978:	81a080e7          	jalr	-2022(ra) # 8000818e <lst_push>
  for(; k > fk; k--) {
    8000797c:	fb8497e3          	bne	s1,s8,8000792a <bd_malloc+0xf0>
  }
  release(&lock);
    80007980:	00022517          	auipc	a0,0x22
    80007984:	9c050513          	addi	a0,a0,-1600 # 80029340 <lock>
    80007988:	ffff9097          	auipc	ra,0xffff9
    8000798c:	1f4080e7          	jalr	500(ra) # 80000b7c <release>

  return p;
}
    80007990:	855a                	mv	a0,s6
    80007992:	70a6                	ld	ra,104(sp)
    80007994:	7406                	ld	s0,96(sp)
    80007996:	64e6                	ld	s1,88(sp)
    80007998:	6946                	ld	s2,80(sp)
    8000799a:	69a6                	ld	s3,72(sp)
    8000799c:	6a06                	ld	s4,64(sp)
    8000799e:	7ae2                	ld	s5,56(sp)
    800079a0:	7b42                	ld	s6,48(sp)
    800079a2:	7ba2                	ld	s7,40(sp)
    800079a4:	7c02                	ld	s8,32(sp)
    800079a6:	6ce2                	ld	s9,24(sp)
    800079a8:	6d42                	ld	s10,16(sp)
    800079aa:	6da2                	ld	s11,8(sp)
    800079ac:	6165                	addi	sp,sp,112
    800079ae:	8082                	ret

00000000800079b0 <size>:

// Find the size of the block that p points to.
int
size(char *p) {
    800079b0:	7139                	addi	sp,sp,-64
    800079b2:	fc06                	sd	ra,56(sp)
    800079b4:	f822                	sd	s0,48(sp)
    800079b6:	f426                	sd	s1,40(sp)
    800079b8:	f04a                	sd	s2,32(sp)
    800079ba:	ec4e                	sd	s3,24(sp)
    800079bc:	e852                	sd	s4,16(sp)
    800079be:	e456                	sd	s5,8(sp)
    800079c0:	e05a                	sd	s6,0(sp)
    800079c2:	0080                	addi	s0,sp,64
  for (int k = 0; k < nsizes; k++) {
    800079c4:	00022a97          	auipc	s5,0x22
    800079c8:	9e4aaa83          	lw	s5,-1564(s5) # 800293a8 <nsizes>
  return n / BLK_SIZE(k);
    800079cc:	00022a17          	auipc	s4,0x22
    800079d0:	9cca3a03          	ld	s4,-1588(s4) # 80029398 <bd_base>
    800079d4:	41450a3b          	subw	s4,a0,s4
    800079d8:	00022497          	auipc	s1,0x22
    800079dc:	9c84b483          	ld	s1,-1592(s1) # 800293a0 <bd_sizes>
    800079e0:	03848493          	addi	s1,s1,56
  for (int k = 0; k < nsizes; k++) {
    800079e4:	4901                	li	s2,0
  return n / BLK_SIZE(k);
    800079e6:	4b41                	li	s6,16
  for (int k = 0; k < nsizes; k++) {
    800079e8:	03595363          	bge	s2,s5,80007a0e <size+0x5e>
    if(bit_isset(bd_sizes[k+1].split, blk_index(k+1, p))) {
    800079ec:	0019099b          	addiw	s3,s2,1
  return n / BLK_SIZE(k);
    800079f0:	013b15b3          	sll	a1,s6,s3
    800079f4:	02ba45b3          	div	a1,s4,a1
    if(bit_isset(bd_sizes[k+1].split, blk_index(k+1, p))) {
    800079f8:	2581                	sext.w	a1,a1
    800079fa:	6088                	ld	a0,0(s1)
    800079fc:	00000097          	auipc	ra,0x0
    80007a00:	b82080e7          	jalr	-1150(ra) # 8000757e <bit_isset>
    80007a04:	02048493          	addi	s1,s1,32
    80007a08:	e501                	bnez	a0,80007a10 <size+0x60>
  for (int k = 0; k < nsizes; k++) {
    80007a0a:	894e                	mv	s2,s3
    80007a0c:	bff1                	j	800079e8 <size+0x38>
      return k;
    }
  }
  return 0;
    80007a0e:	4901                	li	s2,0
}
    80007a10:	854a                	mv	a0,s2
    80007a12:	70e2                	ld	ra,56(sp)
    80007a14:	7442                	ld	s0,48(sp)
    80007a16:	74a2                	ld	s1,40(sp)
    80007a18:	7902                	ld	s2,32(sp)
    80007a1a:	69e2                	ld	s3,24(sp)
    80007a1c:	6a42                	ld	s4,16(sp)
    80007a1e:	6aa2                	ld	s5,8(sp)
    80007a20:	6b02                	ld	s6,0(sp)
    80007a22:	6121                	addi	sp,sp,64
    80007a24:	8082                	ret

0000000080007a26 <bd_free>:

// Free memory pointed to by p, which was earlier allocated using
// bd_malloc.
void
bd_free(void *p) {
    80007a26:	7159                	addi	sp,sp,-112
    80007a28:	f486                	sd	ra,104(sp)
    80007a2a:	f0a2                	sd	s0,96(sp)
    80007a2c:	eca6                	sd	s1,88(sp)
    80007a2e:	e8ca                	sd	s2,80(sp)
    80007a30:	e4ce                	sd	s3,72(sp)
    80007a32:	e0d2                	sd	s4,64(sp)
    80007a34:	fc56                	sd	s5,56(sp)
    80007a36:	f85a                	sd	s6,48(sp)
    80007a38:	f45e                	sd	s7,40(sp)
    80007a3a:	f062                	sd	s8,32(sp)
    80007a3c:	ec66                	sd	s9,24(sp)
    80007a3e:	e86a                	sd	s10,16(sp)
    80007a40:	e46e                	sd	s11,8(sp)
    80007a42:	1880                	addi	s0,sp,112
    80007a44:	8aaa                	mv	s5,a0
  void *q;
  int k;

  acquire(&lock);
    80007a46:	00022517          	auipc	a0,0x22
    80007a4a:	8fa50513          	addi	a0,a0,-1798 # 80029340 <lock>
    80007a4e:	ffff9097          	auipc	ra,0xffff9
    80007a52:	05e080e7          	jalr	94(ra) # 80000aac <acquire>
  for (k = size(p); k < MAXSIZE; k++) {
    80007a56:	8556                	mv	a0,s5
    80007a58:	00000097          	auipc	ra,0x0
    80007a5c:	f58080e7          	jalr	-168(ra) # 800079b0 <size>
    80007a60:	84aa                	mv	s1,a0
    80007a62:	00022797          	auipc	a5,0x22
    80007a66:	9467a783          	lw	a5,-1722(a5) # 800293a8 <nsizes>
    80007a6a:	37fd                	addiw	a5,a5,-1
    80007a6c:	0af55d63          	bge	a0,a5,80007b26 <bd_free+0x100>
    80007a70:	00551a13          	slli	s4,a0,0x5
  int n = p - (char *) bd_base;
    80007a74:	00022c17          	auipc	s8,0x22
    80007a78:	924c0c13          	addi	s8,s8,-1756 # 80029398 <bd_base>
  return n / BLK_SIZE(k);
    80007a7c:	4bc1                	li	s7,16
    int bi = blk_index(k, p);
    int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    bit_clear(bd_sizes[k].alloc, bi);  // free p at size k
    80007a7e:	00022b17          	auipc	s6,0x22
    80007a82:	922b0b13          	addi	s6,s6,-1758 # 800293a0 <bd_sizes>
  for (k = size(p); k < MAXSIZE; k++) {
    80007a86:	00022c97          	auipc	s9,0x22
    80007a8a:	922c8c93          	addi	s9,s9,-1758 # 800293a8 <nsizes>
    80007a8e:	a82d                	j	80007ac8 <bd_free+0xa2>
    int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    80007a90:	fff58d9b          	addiw	s11,a1,-1
    80007a94:	a881                	j	80007ae4 <bd_free+0xbe>
    if(buddy % 2 == 0) {
      p = q;
    }
    ...
    80007a96:	020a0a13          	addi	s4,s4,32
    80007a9a:	2485                	addiw	s1,s1,1
  int n = p - (char *) bd_base;
    80007a9c:	000c3583          	ld	a1,0(s8)
  return n / BLK_SIZE(k);
    80007aa0:	40ba85bb          	subw	a1,s5,a1
    80007aa4:	009b97b3          	sll	a5,s7,s1
    80007aa8:	02f5c5b3          	div	a1,a1,a5
    bit_clear(bd_sizes[k+1].split, blk_index(k+1, p));
    80007aac:	000b3783          	ld	a5,0(s6)
    80007ab0:	97d2                	add	a5,a5,s4
    80007ab2:	2581                	sext.w	a1,a1
    80007ab4:	6f88                	ld	a0,24(a5)
    80007ab6:	00000097          	auipc	ra,0x0
    80007aba:	b30080e7          	jalr	-1232(ra) # 800075e6 <bit_clear>
  for (k = size(p); k < MAXSIZE; k++) {
    80007abe:	000ca783          	lw	a5,0(s9)
    80007ac2:	37fd                	addiw	a5,a5,-1
    80007ac4:	06f4d163          	bge	s1,a5,80007b26 <bd_free+0x100>
  int n = p - (char *) bd_base;
    80007ac8:	000c3903          	ld	s2,0(s8)
  return n / BLK_SIZE(k);
    80007acc:	009b99b3          	sll	s3,s7,s1
    80007ad0:	412a87bb          	subw	a5,s5,s2
    80007ad4:	0337c7b3          	div	a5,a5,s3
    80007ad8:	0007859b          	sext.w	a1,a5
    int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    80007adc:	8b85                	andi	a5,a5,1
    80007ade:	fbcd                	bnez	a5,80007a90 <bd_free+0x6a>
    80007ae0:	00158d9b          	addiw	s11,a1,1
    bit_clear(bd_sizes[k].alloc, bi);  // free p at size k
    80007ae4:	000b3d03          	ld	s10,0(s6)
    80007ae8:	9d52                	add	s10,s10,s4
    80007aea:	010d3503          	ld	a0,16(s10)
    80007aee:	00000097          	auipc	ra,0x0
    80007af2:	af8080e7          	jalr	-1288(ra) # 800075e6 <bit_clear>
    if (bit_isset(bd_sizes[k].alloc, buddy)) {  // is buddy allocated?
    80007af6:	85ee                	mv	a1,s11
    80007af8:	010d3503          	ld	a0,16(s10)
    80007afc:	00000097          	auipc	ra,0x0
    80007b00:	a82080e7          	jalr	-1406(ra) # 8000757e <bit_isset>
    80007b04:	e10d                	bnez	a0,80007b26 <bd_free+0x100>
  int n = bi * BLK_SIZE(k);
    80007b06:	000d8d1b          	sext.w	s10,s11
  return (char *) bd_base + n;
    80007b0a:	03b989bb          	mulw	s3,s3,s11
    80007b0e:	994e                	add	s2,s2,s3
    lst_remove(q);    // remove buddy from free list
    80007b10:	854a                	mv	a0,s2
    80007b12:	00000097          	auipc	ra,0x0
    80007b16:	630080e7          	jalr	1584(ra) # 80008142 <lst_remove>
    if(buddy % 2 == 0) {
    80007b1a:	001d7d13          	andi	s10,s10,1
    80007b1e:	f60d1ce3          	bnez	s10,80007a96 <bd_free+0x70>
      p = q;
    80007b22:	8aca                	mv	s5,s2
    80007b24:	bf8d                	j	80007a96 <bd_free+0x70>
  }
  lst_push(&bd_sizes[k].free, p);
    80007b26:	0496                	slli	s1,s1,0x5
    80007b28:	85d6                	mv	a1,s5
    80007b2a:	00022517          	auipc	a0,0x22
    80007b2e:	87653503          	ld	a0,-1930(a0) # 800293a0 <bd_sizes>
    80007b32:	9526                	add	a0,a0,s1
    80007b34:	00000097          	auipc	ra,0x0
    80007b38:	65a080e7          	jalr	1626(ra) # 8000818e <lst_push>
  release(&lock);
    80007b3c:	00022517          	auipc	a0,0x22
    80007b40:	80450513          	addi	a0,a0,-2044 # 80029340 <lock>
    80007b44:	ffff9097          	auipc	ra,0xffff9
    80007b48:	038080e7          	jalr	56(ra) # 80000b7c <release>
}
    80007b4c:	70a6                	ld	ra,104(sp)
    80007b4e:	7406                	ld	s0,96(sp)
    80007b50:	64e6                	ld	s1,88(sp)
    80007b52:	6946                	ld	s2,80(sp)
    80007b54:	69a6                	ld	s3,72(sp)
    80007b56:	6a06                	ld	s4,64(sp)
    80007b58:	7ae2                	ld	s5,56(sp)
    80007b5a:	7b42                	ld	s6,48(sp)
    80007b5c:	7ba2                	ld	s7,40(sp)
    80007b5e:	7c02                	ld	s8,32(sp)
    80007b60:	6ce2                	ld	s9,24(sp)
    80007b62:	6d42                	ld	s10,16(sp)
    80007b64:	6da2                	ld	s11,8(sp)
    80007b66:	6165                	addi	sp,sp,112
    80007b68:	8082                	ret

0000000080007b6a <blk_index_next>:

// Compute the first block at size k that doesn't contain p
int
blk_index_next(int k, char *p) {
    80007b6a:	1141                	addi	sp,sp,-16
    80007b6c:	e422                	sd	s0,8(sp)
    80007b6e:	0800                	addi	s0,sp,16
  int n = (p - (char *) bd_base) / BLK_SIZE(k);
    80007b70:	00022797          	auipc	a5,0x22
    80007b74:	8287b783          	ld	a5,-2008(a5) # 80029398 <bd_base>
    80007b78:	8d9d                	sub	a1,a1,a5
    80007b7a:	47c1                	li	a5,16
    80007b7c:	00a797b3          	sll	a5,a5,a0
    80007b80:	02f5c533          	div	a0,a1,a5
    80007b84:	2501                	sext.w	a0,a0
  if((p - (char*) bd_base) % BLK_SIZE(k) != 0)
    80007b86:	02f5e5b3          	rem	a1,a1,a5
    80007b8a:	c191                	beqz	a1,80007b8e <blk_index_next+0x24>
      n++;
    80007b8c:	2505                	addiw	a0,a0,1
  return n ;
}
    80007b8e:	6422                	ld	s0,8(sp)
    80007b90:	0141                	addi	sp,sp,16
    80007b92:	8082                	ret

0000000080007b94 <log2>:

int
log2(uint64 n) {
    80007b94:	1141                	addi	sp,sp,-16
    80007b96:	e422                	sd	s0,8(sp)
    80007b98:	0800                	addi	s0,sp,16
  int k = 0;
  while (n > 1) {
    80007b9a:	4705                	li	a4,1
    80007b9c:	00a77b63          	bgeu	a4,a0,80007bb2 <log2+0x1e>
    80007ba0:	87aa                	mv	a5,a0
  int k = 0;
    80007ba2:	4501                	li	a0,0
    k++;
    80007ba4:	2505                	addiw	a0,a0,1
    n = n >> 1;
    80007ba6:	8385                	srli	a5,a5,0x1
  while (n > 1) {
    80007ba8:	fef76ee3          	bltu	a4,a5,80007ba4 <log2+0x10>
  }
  return k;
}
    ...
    80007bb0:	8082                	ret
  int k = 0;
    80007bb2:	4501                	li	a0,0
    80007bb4:	bfe5                	j	80007bac <log2+0x18>

0000000080007bb6 <bd_mark>:

// Mark memory from [start, stop), starting at size 0, as allocated. 
void
bd_mark(void *start, void *stop)
{
    80007bb6:	711d                	addi	sp,sp,-96
    80007bb8:	ec86                	sd	ra,88(sp)
    80007bba:	e8a2                	sd	s0,80(sp)
    80007bbc:	e4a6                	sd	s1,72(sp)
    80007bbe:	e0ca                	sd	s2,64(sp)
    80007bc0:	fc4e                	sd	s3,56(sp)
    80007bc2:	f852                	sd	s4,48(sp)
    80007bc4:	f456                	sd	s5,40(sp)
    80007bc6:	f05a                	sd	s6,32(sp)
    80007bc8:	ec5e                	sd	s7,24(sp)
    80007bca:	e862                	sd	s8,16(sp)
    80007bcc:	e466                	sd	s9,8(sp)
    80007bce:	e06a                	sd	s10,0(sp)
    80007bd0:	1080                	addi	s0,sp,96
  int bi, bj;

  if (((uint64) start % LEAF_SIZE != 0) || ((uint64) stop % LEAF_SIZE != 0))
    80007bd2:	00b56933          	or	s2,a0,a1
    80007bd6:	00f97913          	andi	s2,s2,15
    80007bda:	04091263          	bnez	s2,80007c1e <bd_mark+0x68>
    80007bde:	8b2a                	mv	s6,a0
    80007be0:	8bae                	mv	s7,a1
    panic("bd_mark");

  for (int k = 0; k < nsizes; k++) {
    80007be2:	00021c17          	auipc	s8,0x21
    80007be6:	7c6c2c03          	lw	s8,1990(s8) # 800293a8 <nsizes>
    80007bea:	4981                	li	s3,0
  int n = p - (char *) bd_base;
    80007bec:	00021d17          	auipc	s10,0x21
    80007bf0:	7acd0d13          	addi	s10,s10,1964 # 80029398 <bd_base>
  return n / BLK_SIZE(k);
    80007bf4:	4cc1                	li	s9,16
    ...
    80007bf6:	00021a97          	auipc	s5,0x21
    80007bfa:	7aaa8a93          	addi	s5,s5,1962 # 800293a0 <bd_sizes>
  for (int k = 0; k < nsizes; k++) {
    80007bfe:	07804563          	bgtz	s8,80007c68 <bd_mark+0xb2>
      }
      bit_set(bd_sizes[k].alloc, bi);
    }
  }
}
    80007c02:	60e6                	ld	ra,88(sp)
    80007c04:	6446                	ld	s0,80(sp)
    80007c06:	64a6                	ld	s1,72(sp)
    80007c08:	6906                	ld	s2,64(sp)
    80007c0a:	79e2                	ld	s3,56(sp)
    80007c0c:	7a42                	ld	s4,48(sp)
    80007c0e:	7aa2                	ld	s5,40(sp)
    80007c10:	7b02                	ld	s6,32(sp)
    80007c12:	6be2                	ld	s7,24(sp)
    80007c14:	6c42                	ld	s8,16(sp)
    80007c16:	6ca2                	ld	s9,8(sp)
    80007c18:	6d02                	ld	s10,0(sp)
    80007c1a:	6125                	addi	sp,sp,96
    80007c1c:	8082                	ret
    panic("bd_mark");
    80007c1e:	00002517          	auipc	a0,0x2
    80007c22:	05a50513          	addi	a0,a0,90 # 80009c78 <userret+0xbe8>
    80007c26:	ffff9097          	auipc	ra,0xffff9
    80007c2a:	934080e7          	jalr	-1740(ra) # 8000055a <panic>
      bit_set(bd_sizes[k].alloc, bi);
    80007c2e:	000ab783          	ld	a5,0(s5)
    80007c32:	97ca                	add	a5,a5,s2
    80007c34:	85a6                	mv	a1,s1
    80007c36:	6b88                	ld	a0,16(a5)
    80007c38:	00000097          	auipc	ra,0x0
    80007c3c:	97e080e7          	jalr	-1666(ra) # 800075b6 <bit_set>
    for(; bi < bj; bi++) {
    80007c40:	2485                	addiw	s1,s1,1
    80007c42:	009a0e63          	beq	s4,s1,80007c5e <bd_mark+0xa8>
      if(k > 0) {
    80007c46:	ff3054e3          	blez	s3,80007c2e <bd_mark+0x78>
        bit_set(bd_sizes[k].split, bi);
    80007c4a:	000ab783          	ld	a5,0(s5)
    80007c4e:	97ca                	add	a5,a5,s2
    80007c50:	85a6                	mv	a1,s1
    80007c52:	6f88                	ld	a0,24(a5)
    80007c54:	00000097          	auipc	ra,0x0
    80007c58:	962080e7          	jalr	-1694(ra) # 800075b6 <bit_set>
    80007c5c:	bfc9                	j	80007c2e <bd_mark+0x78>
  for (int k = 0; k < nsizes; k++) {
    80007c5e:	2985                	addiw	s3,s3,1
    80007c60:	02090913          	addi	s2,s2,32
    80007c64:	f9898fe3          	beq	s3,s8,80007c02 <bd_mark+0x4c>
  int n = p - (char *) bd_base;
    80007c68:	000d3483          	ld	s1,0(s10)
  return n / BLK_SIZE(k);
    80007c6c:	409b04bb          	subw	s1,s6,s1
    80007c70:	013c97b3          	sll	a5,s9,s3
    80007c74:	02f4c4b3          	div	s1,s1,a5
    80007c78:	2481                	sext.w	s1,s1
    bj = blk_index_next(k, stop);
    80007c7a:	85de                	mv	a1,s7
    80007c7c:	854e                	mv	a0,s3
    80007c7e:	00000097          	auipc	ra,0x0
    80007c82:	eec080e7          	jalr	-276(ra) # 80007b6a <blk_index_next>
    80007c86:	8a2a                	mv	s4,a0
    for(; bi < bj; bi++) {
    80007c88:	faa4cfe3          	blt	s1,a0,80007c46 <bd_mark+0x90>
    80007c8c:	bfc9                	j	80007c5e <bd_mark+0xa8>

0000000080007c8e <bd_initfree_pair>:

// If a block is marked as allocated and the buddy is free, put the
// buddy on the free list at size k.
int
bd_initfree_pair(int k, int bi) {
    80007c8e:	7139                	addi	sp,sp,-64
    80007c90:	fc06                	sd	ra,56(sp)
    80007c92:	f822                	sd	s0,48(sp)
    80007c94:	f426                	sd	s1,40(sp)
    80007c96:	f04a                	sd	s2,32(sp)
    80007c98:	ec4e                	sd	s3,24(sp)
    80007c9a:	e852                	sd	s4,16(sp)
    80007c9c:	e456                	sd	s5,8(sp)
    80007c9e:	e05a                	sd	s6,0(sp)
    80007ca0:	0080                	addi	s0,sp,64
    80007ca2:	89aa                	mv	s3,a0
  int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    80007ca4:	00058a9b          	sext.w	s5,a1
    80007ca8:	0015f793          	andi	a5,a1,1
    80007cac:	ebad                	bnez	a5,80007d1e <bd_initfree_pair+0x90>
    80007cae:	00158a1b          	addiw	s4,a1,1
  int free = 0;
  if(bit_isset(bd_sizes[k].alloc, bi) !=  bit_isset(bd_sizes[k].alloc, buddy)) {
    80007cb2:	00599493          	slli	s1,s3,0x5
    80007cb6:	00021797          	auipc	a5,0x21
    80007cba:	6ea7b783          	ld	a5,1770(a5) # 800293a0 <bd_sizes>
    80007cbe:	94be                	add	s1,s1,a5
    80007cc0:	0104bb03          	ld	s6,16(s1)
    80007cc4:	855a                	mv	a0,s6
    80007cc6:	00000097          	auipc	ra,0x0
    80007cca:	8b8080e7          	jalr	-1864(ra) # 8000757e <bit_isset>
    80007cce:	892a                	mv	s2,a0
    80007cd0:	85d2                	mv	a1,s4
    80007cd2:	855a                	mv	a0,s6
    80007cd4:	00000097          	auipc	ra,0x0
    80007cd8:	8aa080e7          	jalr	-1878(ra) # 8000757e <bit_isset>
  int free = 0;
    80007cdc:	4b01                	li	s6,0
  if(bit_isset(bd_sizes[k].alloc, bi) !=  bit_isset(bd_sizes[k].alloc, buddy)) {
    80007cde:	02a90563          	beq	s2,a0,80007d08 <bd_initfree_pair+0x7a>
    // one of the pair is free
    free = BLK_SIZE(k);
    80007ce2:	45c1                	li	a1,16
    80007ce4:	013599b3          	sll	s3,a1,s3
    80007ce8:	00098b1b          	sext.w	s6,s3
    if(bit_isset(bd_sizes[k].alloc, bi))
    80007cec:	02090c63          	beqz	s2,80007d24 <bd_initfree_pair+0x96>
  return (char *) bd_base + n;
    80007cf0:	034989bb          	mulw	s3,s3,s4
      lst_push(&bd_sizes[k].free, addr(k, buddy));   // put buddy on free list
    80007cf4:	00021597          	auipc	a1,0x21
    80007cf8:	6a45b583          	ld	a1,1700(a1) # 80029398 <bd_base>
    80007cfc:	95ce                	add	a1,a1,s3
    80007cfe:	8526                	mv	a0,s1
    80007d00:	00000097          	auipc	ra,0x0
    80007d04:	48e080e7          	jalr	1166(ra) # 8000818e <lst_push>
    else
      lst_push(&bd_sizes[k].free, addr(k, bi));      // put bi on free list
  }
  return free;
}
    80007d08:	855a                	mv	a0,s6
    80007d0a:	70e2                	ld	ra,56(sp)
    80007d0c:	7442                	ld	s0,48(sp)
    80007d0e:	74a2                	ld	s1,40(sp)
    80007d10:	7902                	ld	s2,32(sp)
    80007d12:	69e2                	ld	s3,24(sp)
    80007d14:	6a42                	ld	s4,16(sp)
    80007d16:	6aa2                	ld	s5,8(sp)
    80007d18:	6b02                	ld	s6,0(sp)
    80007d1a:	6121                	addi	sp,sp,64
    80007d1c:	8082                	ret
  int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    80007d1e:	fff58a1b          	addiw	s4,a1,-1
    80007d22:	bf41                	j	80007cb2 <bd_initfree_pair+0x24>
  return (char *) bd_base + n;
    80007d24:	035989bb          	mulw	s3,s3,s5
      lst_push(&bd_sizes[k].free, addr(k, bi));      // put bi on free list
    80007d28:	00021597          	auipc	a1,0x21
    80007d2c:	6705b583          	ld	a1,1648(a1) # 80029398 <bd_base>
    80007d30:	95ce                	add	a1,a1,s3
    80007d32:	8526                	mv	a0,s1
    80007d34:	00000097          	auipc	ra,0x0
    80007d38:	45a080e7          	jalr	1114(ra) # 8000818e <lst_push>
    80007d3c:	b7f1                	j	80007d08 <bd_initfree_pair+0x7a>

0000000080007d3e <bd_initfree>:
...
bd_initfree(void *bd_left, void *bd_right) {
    80007d3e:	711d                	addi	sp,sp,-96
    80007d40:	ec86                	sd	ra,88(sp)
    80007d42:	e8a2                	sd	s0,80(sp)
    80007d44:	e4a6                	sd	s1,72(sp)
    80007d46:	e0ca                	sd	s2,64(sp)
    80007d48:	fc4e                	sd	s3,56(sp)
    80007d4a:	f852                	sd	s4,48(sp)
    80007d4c:	f456                	sd	s5,40(sp)
    80007d4e:	f05a                	sd	s6,32(sp)
    80007d50:	ec5e                	sd	s7,24(sp)
    80007d52:	e862                	sd	s8,16(sp)
    80007d54:	e466                	sd	s9,8(sp)
    80007d56:	e06a                	sd	s10,0(sp)
    80007d58:	1080                	addi	s0,sp,96
  int free = 0;

  for (int k = 0; k < MAXSIZE; k++) {   // skip max size
    80007d5a:	00021717          	auipc	a4,0x21
    80007d5e:	64e72703          	lw	a4,1614(a4) # 800293a8 <nsizes>
    80007d62:	4785                	li	a5,1
    80007d64:	06e7db63          	bge	a5,a4,80007dda <bd_initfree+0x9c>
    80007d68:	8aaa                	mv	s5,a0
    80007d6a:	8b2e                	mv	s6,a1
    80007d6c:	4901                	li	s2,0
  int free = 0;
    80007d6e:	4a01                	li	s4,0
  int n = p - (char *) bd_base;
    80007d70:	00021c97          	auipc	s9,0x21
    80007d74:	628c8c93          	addi	s9,s9,1576 # 80029398 <bd_base>
  return n / BLK_SIZE(k);
    80007d78:	4c41                	li	s8,16
  for (int k = 0; k < MAXSIZE; k++) {   // skip max size
    80007d7a:	00021b97          	auipc	s7,0x21
    80007d7e:	62eb8b93          	addi	s7,s7,1582 # 800293a8 <nsizes>
    80007d82:	a039                	j	80007d90 <bd_initfree+0x52>
    80007d84:	2905                	addiw	s2,s2,1
    80007d86:	000ba783          	lw	a5,0(s7)
    80007d8a:	37fd                	addiw	a5,a5,-1
    80007d8c:	04f95863          	bge	s2,a5,80007ddc <bd_initfree+0x9e>
    int left = blk_index_next(k, bd_left);
    80007d90:	85d6                	mv	a1,s5
    80007d92:	854a                	mv	a0,s2
    80007d94:	00000097          	auipc	ra,0x0
    80007d98:	dd6080e7          	jalr	-554(ra) # 80007b6a <blk_index_next>
    80007d9c:	89aa                	mv	s3,a0
  int n = p - (char *) bd_base;
    80007d9e:	000cb483          	ld	s1,0(s9)
  return n / BLK_SIZE(k);
    80007da2:	409b04bb          	subw	s1,s6,s1
    80007da6:	012c17b3          	sll	a5,s8,s2
    80007daa:	02f4c4b3          	div	s1,s1,a5
    80007dae:	2481                	sext.w	s1,s1
    int right = blk_index(k, bd_right);
    free += bd_initfree_pair(k, left);
    80007db0:	85aa                	mv	a1,a0
    80007db2:	854a                	mv	a0,s2
    80007db4:	00000097          	auipc	ra,0x0
    80007db8:	eda080e7          	jalr	-294(ra) # 80007c8e <bd_initfree_pair>
    80007dbc:	01450d3b          	addw	s10,a0,s4
    80007dc0:	000d0a1b          	sext.w	s4,s10
    if(right <= left)
    80007dc4:	fc99d0e3          	bge	s3,s1,80007d84 <bd_initfree+0x46>
      continue;
    free += bd_initfree_pair(k, right);
    80007dc8:	85a6                	mv	a1,s1
    80007dca:	854a                	mv	a0,s2
    80007dcc:	00000097          	auipc	ra,0x0
    80007dd0:	ec2080e7          	jalr	-318(ra) # 80007c8e <bd_initfree_pair>
    80007dd4:	00ad0a3b          	addw	s4,s10,a0
    80007dd8:	b775                	j	80007d84 <bd_initfree+0x46>
  int free = 0;
    80007dda:	4a01                	li	s4,0
  }
  return free;
}
    80007ddc:	8552                	mv	a0,s4
    80007dde:	60e6                	ld	ra,88(sp)
    80007de0:	6446                	ld	s0,80(sp)
    80007de2:	64a6                	ld	s1,72(sp)
    80007de4:	6906                	ld	s2,64(sp)
    80007de6:	79e2                	ld	s3,56(sp)
    80007de8:	7a42                	ld	s4,48(sp)
    80007dea:	7aa2                	ld	s5,40(sp)
    80007dec:	7b02                	ld	s6,32(sp)
    80007dee:	6be2                	ld	s7,24(sp)
    80007df0:	6c42                	ld	s8,16(sp)
    80007df2:	6ca2                	ld	s9,8(sp)
    80007df4:	6d02                	ld	s10,0(sp)
    80007df6:	6125                	addi	sp,sp,96
    80007df8:	8082                	ret

0000000080007dfa <bd_mark_data_structures>:

// Mark the range [bd_base,p) as allocated
int
bd_mark_data_structures(char *p) {
    80007dfa:	7179                	addi	sp,sp,-48
    80007dfc:	f406                	sd	ra,40(sp)
    80007dfe:	f022                	sd	s0,32(sp)
    80007e00:	ec26                	sd	s1,24(sp)
    80007e02:	e84a                	sd	s2,16(sp)
    80007e04:	e44e                	sd	s3,8(sp)
    80007e06:	1800                	addi	s0,sp,48
    80007e08:	892a                	mv	s2,a0
  int meta = p - (char*)bd_base;
    80007e0a:	00021997          	auipc	s3,0x21
    80007e0e:	58e98993          	addi	s3,s3,1422 # 80029398 <bd_base>
    80007e12:	0009b483          	ld	s1,0(s3)
    80007e16:	409504bb          	subw	s1,a0,s1
  printf("bd: %d meta bytes for managing %d bytes of memory\n", meta, BLK_SIZE(MAXSIZE));
    80007e1a:	00021797          	auipc	a5,0x21
    80007e1e:	58e7a783          	lw	a5,1422(a5) # 800293a8 <nsizes>
    80007e22:	37fd                	addiw	a5,a5,-1
    80007e24:	4641                	li	a2,16
    80007e26:	00f61633          	sll	a2,a2,a5
    80007e2a:	85a6                	mv	a1,s1
    80007e2c:	00002517          	auipc	a0,0x2
    80007e30:	e5450513          	addi	a0,a0,-428 # 80009c80 <userret+0xbf0>
    80007e34:	ffff8097          	auipc	ra,0xffff8
    80007e38:	780080e7          	jalr	1920(ra) # 800005b4 <printf>
  bd_mark(bd_base, p);
    80007e3c:	85ca                	mv	a1,s2
    80007e3e:	0009b503          	ld	a0,0(s3)
    80007e42:	00000097          	auipc	ra,0x0
    80007e46:	d74080e7          	jalr	-652(ra) # 80007bb6 <bd_mark>
  return meta;
}
    80007e4a:	8526                	mv	a0,s1
    80007e4c:	70a2                	ld	ra,40(sp)
    80007e4e:	7402                	ld	s0,32(sp)
    80007e50:	64e2                	ld	s1,24(sp)
    80007e52:	6942                	ld	s2,16(sp)
    80007e54:	69a2                	ld	s3,8(sp)
    80007e56:	6145                	addi	sp,sp,48
    80007e58:	8082                	ret

0000000080007e5a <bd_mark_unavailable>:

// Mark the range [end, HEAPSIZE) as allocated
int
bd_mark_unavailable(void *end, void *left) {
    80007e5a:	1101                	addi	sp,sp,-32
    80007e5c:	ec06                	sd	ra,24(sp)
    80007e5e:	e822                	sd	s0,16(sp)
    80007e60:	e426                	sd	s1,8(sp)
    80007e62:	1000                	addi	s0,sp,32
  int unavailable = BLK_SIZE(MAXSIZE)-(end-bd_base);
    80007e64:	00021497          	auipc	s1,0x21
    80007e68:	5444a483          	lw	s1,1348(s1) # 800293a8 <nsizes>
    80007e6c:	fff4879b          	addiw	a5,s1,-1
    80007e70:	44c1                	li	s1,16
    80007e72:	00f494b3          	sll	s1,s1,a5
    80007e76:	00021797          	auipc	a5,0x21
    80007e7a:	5227b783          	ld	a5,1314(a5) # 80029398 <bd_base>
    80007e7e:	8d1d                	sub	a0,a0,a5
    80007e80:	40a4853b          	subw	a0,s1,a0
    80007e84:	0005049b          	sext.w	s1,a0
  if(unavailable > 0)
    80007e88:	00905a63          	blez	s1,80007e9c <bd_mark_unavailable+0x42>
    unavailable = ROUNDUP(unavailable, LEAF_SIZE);
    80007e8c:	357d                	addiw	a0,a0,-1
    80007e8e:	41f5549b          	sraiw	s1,a0,0x1f
    80007e92:	01c4d49b          	srliw	s1,s1,0x1c
    80007e96:	9ca9                	addw	s1,s1,a0
    80007e98:	98c1                	andi	s1,s1,-16
    80007e9a:	24c1                	addiw	s1,s1,16
  ...
  void *bd_end = bd_base+BLK_SIZE(MAXSIZE)-unavailable;
    80007eae:	00021717          	auipc	a4,0x21
    80007eb2:	4ea73703          	ld	a4,1258(a4) # 80029398 <bd_base>
    80007eb6:	00021597          	auipc	a1,0x21
    80007eba:	4f25a583          	lw	a1,1266(a1) # 800293a8 <nsizes>
    80007ebe:	fff5879b          	addiw	a5,a1,-1
    80007ec2:	45c1                	li	a1,16
    80007ec4:	00f595b3          	sll	a1,a1,a5
    80007ec8:	40958533          	sub	a0,a1,s1
  bd_mark(bd_end, bd_base+BLK_SIZE(MAXSIZE));
    80007ecc:	95ba                	add	a1,a1,a4
    80007ece:	953a                	add	a0,a0,a4
    80007ed0:	00000097          	auipc	ra,0x0
    80007ed4:	ce6080e7          	jalr	-794(ra) # 80007bb6 <bd_mark>
  return unavailable;
}
    80007ed8:	8526                	mv	a0,s1
    80007eda:	60e2                	ld	ra,24(sp)
    80007edc:	6442                	ld	s0,16(sp)
    80007ede:	64a2                	ld	s1,8(sp)
    80007ee0:	6105                	addi	sp,sp,32
    80007ee2:	8082                	ret

0000000080007ee4 <bd_init>:

// Initialize the buddy allocator: it manages memory from [base, end).
void
bd_init(void *base, void *end) {
    80007ee4:	715d                	addi	sp,sp,-80
    80007ee6:	e486                	sd	ra,72(sp)
    80007ee8:	e0a2                	sd	s0,64(sp)
    80007eea:	fc26                	sd	s1,56(sp)
    80007eec:	f84a                	sd	s2,48(sp)
    80007eee:	f44e                	sd	s3,40(sp)
    80007ef0:	f052                	sd	s4,32(sp)
    80007ef2:	ec56                	sd	s5,24(sp)
    80007ef4:	e85a                	sd	s6,16(sp)
    80007ef6:	e45e                	sd	s7,8(sp)
    80007ef8:	e062                	sd	s8,0(sp)
    80007efa:	0880                	addi	s0,sp,80
    80007efc:	8c2e                	mv	s8,a1
  char *p = (char *) ROUNDUP((uint64)base, LEAF_SIZE);
    80007efe:	fff50493          	addi	s1,a0,-1
    80007f02:	98c1                	andi	s1,s1,-16
    80007f04:	04c1                	addi	s1,s1,16
  int sz;

  initlock(&lock, "buddy");
    80007f06:	00002597          	auipc	a1,0x2
    80007f0a:	dd258593          	addi	a1,a1,-558 # 80009cd8 <userret+0xc48>
    80007f0e:	00021517          	auipc	a0,0x21
    80007f12:	43250513          	addi	a0,a0,1074 # 80029340 <lock>
    80007f16:	ffff9097          	auipc	ra,0xffff9
    80007f1a:	ac2080e7          	jalr	-1342(ra) # 800009d8 <initlock>
  bd_base = (void *) p;
    80007f1e:	00021797          	auipc	a5,0x21
    80007f22:	4697bd23          	sd	s1,1146(a5) # 80029398 <bd_base>

  // compute the number of sizes we need to manage [base, end)
  nsizes = log2(((char *)end-p)/LEAF_SIZE) + 1;
    80007f26:	409c0933          	sub	s2,s8,s1
    80007f2a:	43f95513          	srai	a0,s2,0x3f
    80007f2e:	893d                	andi	a0,a0,15
    80007f30:	954a                	add	a0,a0,s2
    80007f32:	8511                	srai	a0,a0,0x4
    80007f34:	00000097          	auipc	ra,0x0
    80007f38:	c60080e7          	jalr	-928(ra) # 80007b94 <log2>
  if((char*)end-p > BLK_SIZE(MAXSIZE)) {
    80007f3c:	47c1                	li	a5,16
    80007f3e:	00a797b3          	sll	a5,a5,a0
    80007f42:	1b27c663          	blt	a5,s2,800080ee <bd_init+0x20a>
  nsizes = log2(((char *)end-p)/LEAF_SIZE) + 1;
    80007f46:	2505                	addiw	a0,a0,1
    80007f48:	00021797          	auipc	a5,0x21
    80007f4c:	46a7a023          	sw	a0,1120(a5) # 800293a8 <nsizes>
    nsizes++;  // round up to the next power of 2
  }

  printf("bd: memory sz is %d bytes; allocate an size array of length %d\n",
    80007f50:	00021997          	auipc	s3,0x21
    80007f54:	45898993          	addi	s3,s3,1112 # 800293a8 <nsizes>
    80007f58:	0009a603          	lw	a2,0(s3)
    80007f5c:	85ca                	mv	a1,s2
    80007f5e:	00002517          	auipc	a0,0x2
    80007f62:	d8250513          	addi	a0,a0,-638 # 80009ce0 <userret+0xc50>
    80007f66:	ffff8097          	auipc	ra,0xffff8
    80007f6a:	64e080e7          	jalr	1614(ra) # 800005b4 <printf>
         (char*) end - p, nsizes);

  // allocate bd_sizes array
  bd_sizes = (Sz_info *) p;
    80007f6e:	00021797          	auipc	a5,0x21
    80007f72:	4297b923          	sd	s1,1074(a5) # 800293a0 <bd_sizes>
  p += sizeof(Sz_info) * nsizes;
    80007f76:	0009a603          	lw	a2,0(s3)
    80007f7a:	00561913          	slli	s2,a2,0x5
    80007f7e:	9926                	add	s2,s2,s1
  memset(bd_sizes, 0, sizeof(Sz_info) * nsizes);
    80007f80:	0056161b          	slliw	a2,a2,0x5
    80007f84:	4581                	li	a1,0
    80007f86:	8526                	mv	a0,s1
    80007f88:	ffff9097          	auipc	ra,0xffff9
    80007f8c:	df2080e7          	jalr	-526(ra) # 80000d7a <memset>

  // initialize free list and allocate the alloc array for each size k
  for (int k = 0; k < nsizes; k++) {
    80007f90:	0009a783          	lw	a5,0(s3)
    80007f94:	06f05a63          	blez	a5,80008008 <bd_init+0x124>
    80007f98:	4981                	li	s3,0
    lst_init(&bd_sizes[k].free);
    80007f9a:	00021a97          	auipc	s5,0x21
    80007f9e:	406a8a93          	addi	s5,s5,1030 # 800293a0 <bd_sizes>
    sz = sizeof(char)* ROUNDUP(NBLK(k), 8)/8;
    80007fa2:	00021a17          	auipc	s4,0x21
    80007fa6:	406a0a13          	addi	s4,s4,1030 # 800293a8 <nsizes>
    80007faa:	4b05                	li	s6,1
    lst_init(&bd_sizes[k].free);
    80007fac:	00599b93          	slli	s7,s3,0x5
    80007fb0:	000ab503          	ld	a0,0(s5)
    80007fb4:	955e                	add	a0,a0,s7
    80007fb6:	00000097          	auipc	ra,0x0
    80007fba:	166080e7          	jalr	358(ra) # 8000811c <lst_init>
    sz = sizeof(char)* ROUNDUP(NBLK(k), 8)/8;
    80007fbe:	000a2483          	lw	s1,0(s4)
    80007fc2:	34fd                	addiw	s1,s1,-1
    80007fc4:	413484bb          	subw	s1,s1,s3
    80007fc8:	009b14bb          	sllw	s1,s6,s1
    80007fcc:	fff4879b          	addiw	a5,s1,-1
    80007fd0:	41f7d49b          	sraiw	s1,a5,0x1f
    80007fd4:	01d4d49b          	srliw	s1,s1,0x1d
    80007fd8:	9cbd                	addw	s1,s1,a5
    80007fda:	98e1                	andi	s1,s1,-8
    80007fdc:	24a1                	addiw	s1,s1,8
    bd_sizes[k].alloc = p;
    80007fde:	000ab783          	ld	a5,0(s5)
    80007fe2:	9bbe                	add	s7,s7,a5
    80007fe4:	012bb823          	sd	s2,16(s7)
    memset(bd_sizes[k].alloc, 0, sz);
    80007fe8:	848d                	srai	s1,s1,0x3
    80007fea:	8626                	mv	a2,s1
    80007fec:	4581                	li	a1,0
    80007fee:	854a                	mv	a0,s2
    80007ff0:	ffff9097          	auipc	ra,0xffff9
    80007ff4:	d8a080e7          	jalr	-630(ra) # 80000d7a <memset>
    p += sz;
    80007ff8:	9926                	add	s2,s2,s1
  for (int k = 0; k < nsizes; k++) {
    80007ffa:	0985                	addi	s3,s3,1
    80007ffc:	000a2703          	lw	a4,0(s4)
    80008000:	0009879b          	sext.w	a5,s3
    80008004:	fae7c4e3          	blt	a5,a4,80007fac <bd_init+0xc8>
  }

  // allocate the split array for each size k, except for k = 0, since
  // we will not split blocks of size k = 0, the smallest size.
  for (int k = 1; k < nsizes; k++) {
    80008008:	00021797          	auipc	a5,0x21
    8000800c:	3a07a783          	lw	a5,928(a5) # 800293a8 <nsizes>
    80008010:	4705                	li	a4,1
    80008012:	06f75163          	bge	a4,a5,80008074 <bd_init+0x190>
    80008016:	02000a13          	li	s4,32
    8000801a:	4985                	li	s3,1
    sz = sizeof(char)* (ROUNDUP(NBLK(k), 8))/8;
    8000801c:	4b85                	li	s7,1
    bd_sizes[k].split = p;
    8000801e:	00021b17          	auipc	s6,0x21
    80008022:	382b0b13          	addi	s6,s6,898 # 800293a0 <bd_sizes>
  for (int k = 1; k < nsizes; k++) {
    80008026:	00021a97          	auipc	s5,0x21
    8000802a:	382a8a93          	addi	s5,s5,898 # 800293a8 <nsizes>
    sz = sizeof(char)* (ROUNDUP(NBLK(k), 8))/8;
    8000802e:	37fd                	addiw	a5,a5,-1
    80008030:	413787bb          	subw	a5,a5,s3
    80008034:	00fb94bb          	sllw	s1,s7,a5
    80008038:	fff4879b          	addiw	a5,s1,-1
    8000803c:	41f7d49b          	sraiw	s1,a5,0x1f
    80008040:	01d4d49b          	srliw	s1,s1,0x1d
    80008044:	9cbd                	addw	s1,s1,a5
    80008046:	98e1                	andi	s1,s1,-8
    80008048:	24a1                	addiw	s1,s1,8
    bd_sizes[k].split = p;
    8000804a:	000b3783          	ld	a5,0(s6)
    8000804e:	97d2                	add	a5,a5,s4
    80008050:	0127bc23          	sd	s2,24(a5)
    memset(bd_sizes[k].split, 0, sz);
    80008054:	848d                	srai	s1,s1,0x3
    80008056:	8626                	mv	a2,s1
    80008058:	4581                	li	a1,0
    8000805a:	854a                	mv	a0,s2
    8000805c:	ffff9097          	auipc	ra,0xffff9
    80008060:	d1e080e7          	jalr	-738(ra) # 80000d7a <memset>
    p += sz;
    80008064:	9926                	add	s2,s2,s1
  for (int k = 1; k < nsizes; k++) {
    80008066:	2985                	addiw	s3,s3,1
    80008068:	000aa783          	lw	a5,0(s5)
    8000806c:	020a0a13          	addi	s4,s4,32
    80008070:	faf9cfe3          	blt	s3,a5,8000802e <bd_init+0x14a>
  }
  p = (char *) ROUNDUP((uint64) p, LEAF_SIZE);
    80008074:	197d                	addi	s2,s2,-1
    80008076:	ff097913          	andi	s2,s2,-16
    8000807a:	0941                	addi	s2,s2,16

  // done allocating; mark the memory range [base, p) as allocated, so
  // that buddy will not hand out that memory.
  int meta = bd_mark_data_structures(p);
    8000807c:	854a                	mv	a0,s2
    8000807e:	00000097          	auipc	ra,0x0
    80008082:	d7c080e7          	jalr	-644(ra) # 80007dfa <bd_mark_data_structures>
    80008086:	8a2a                	mv	s4,a0
  
  // mark the unavailable memory range [end, HEAP_SIZE) as allocated,
  // so that buddy will not hand out that memory.
  int unavailable = bd_mark_unavailable(end, p);
    80008088:	85ca                	mv	a1,s2
    8000808a:	8562                	mv	a0,s8
    8000808c:	00000097          	auipc	ra,0x0
    80008090:	dce080e7          	jalr	-562(ra) # 80007e5a <bd_mark_unavailable>
    80008094:	89aa                	mv	s3,a0
  void *bd_end = bd_base+BLK_SIZE(MAXSIZE)-unavailable;
    80008096:	00021a97          	auipc	s5,0x21
    8000809a:	312a8a93          	addi	s5,s5,786 # 800293a8 <nsizes>
    8000809e:	000aa783          	lw	a5,0(s5)
    800080a2:	37fd                	addiw	a5,a5,-1
    800080a4:	44c1                	li	s1,16
    800080a6:	00f497b3          	sll	a5,s1,a5
    800080aa:	8f89                	sub	a5,a5,a0
  
  // initialize free lists for each size k
  int free = bd_initfree(p, bd_end);
    800080ac:	00021597          	auipc	a1,0x21
    800080b0:	2ec5b583          	ld	a1,748(a1) # 80029398 <bd_base>
    800080b4:	95be                	add	a1,a1,a5
    800080b6:	854a                	mv	a0,s2
    800080b8:	00000097          	auipc	ra,0x0
    800080bc:	c86080e7          	jalr	-890(ra) # 80007d3e <bd_initfree>

  // check if the amount that is free is what we expect
  if(free != BLK_SIZE(MAXSIZE)-meta-unavailable) {
    800080c0:	000aa603          	lw	a2,0(s5)
    800080c4:	367d                	addiw	a2,a2,-1
    800080c6:	00c49633          	sll	a2,s1,a2
    800080ca:	41460633          	sub	a2,a2,s4
    800080ce:	41360633          	sub	a2,a2,s3
    800080d2:	02c51463          	bne	a0,a2,800080fa <bd_init+0x216>
    printf("free %d %d\n", free, BLK_SIZE(MAXSIZE)-meta-unavailable);
    panic("bd_init: free mem");
  }
}
    800080d6:	60a6                	ld	ra,72(sp)
    800080d8:	6406                	ld	s0,64(sp)
    800080da:	74e2                	ld	s1,56(sp)
    800080dc:	7942                	ld	s2,48(sp)
    800080de:	79a2                	ld	s3,40(sp)
    800080e0:	7a02                	ld	s4,32(sp)
    800080e2:	6ae2                	ld	s5,24(sp)
    800080e4:	6b42                	ld	s6,16(sp)
    800080e6:	6ba2                	ld	s7,8(sp)
    800080e8:	6c02                	ld	s8,0(sp)
    800080ea:	6161                	addi	sp,sp,80
    800080ec:	8082                	ret
    nsizes++;  // round up to the next power of 2
    800080ee:	2509                	addiw	a0,a0,2
    800080f0:	00021797          	auipc	a5,0x21
    800080f4:	2aa7ac23          	sw	a0,696(a5) # 800293a8 <nsizes>
    800080f8:	bda1                	j	80007f50 <bd_init+0x6c>
    printf("free %d %d\n", free, BLK_SIZE(MAXSIZE)-meta-unavailable);
    800080fa:	85aa                	mv	a1,a0
    800080fc:	00002517          	auipc	a0,0x2
    80008100:	c2450513          	addi	a0,a0,-988 # 80009d20 <userret+0xc90>
    80008104:	ffff8097          	auipc	ra,0xffff8
    80008108:	4b0080e7          	jalr	1200(ra) # 800005b4 <printf>
    panic("bd_init: free mem");
    8000810c:	00002517          	auipc	a0,0x2
    80008110:	c2450513          	addi	a0,a0,-988 # 80009d30 <userret+0xca0>
    80008114:	ffff8097          	auipc	ra,0xffff8
    80008118:	446080e7          	jalr	1094(ra) # 8000055a <panic>

000000008000811c <lst_init>:
...
{
    8000811c:	1141                	addi	sp,sp,-16
    8000811e:	e422                	sd	s0,8(sp)
    80008120:	0800                	addi	s0,sp,16
  lst->next = lst;
    80008122:	e108                	sd	a0,0(a0)
  lst->prev = lst;
    80008124:	e508                	sd	a0,8(a0)
}
    80008126:	6422                	ld	s0,8(sp)
    80008128:	0141                	addi	sp,sp,16
    8000812a:	8082                	ret

000000008000812c <lst_empty>:

int
lst_empty(struct list *lst) {
    8000812c:	1141                	addi	sp,sp,-16
    8000812e:	e422                	sd	s0,8(sp)
    80008130:	0800                	addi	s0,sp,16
  return lst->next == lst;
    80008132:	611c                	ld	a5,0(a0)
    80008134:	40a78533          	sub	a0,a5,a0
}
    80008138:	00153513          	seqz	a0,a0
    8000813c:	6422                	ld	s0,8(sp)
    8000813e:	0141                	addi	sp,sp,16
    80008140:	8082                	ret

0000000080008142 <lst_remove>:

void
lst_remove(struct list *e) {
    80008142:	1141                	addi	sp,sp,-16
    80008144:	e422                	sd	s0,8(sp)
    80008146:	0800                	addi	s0,sp,16
  e->prev->next = e->next;
    80008148:	6518                	ld	a4,8(a0)
    8000814a:	611c                	ld	a5,0(a0)
    8000814c:	e31c                	sd	a5,0(a4)
  e->next->prev = e->prev;
    8000814e:	6518                	ld	a4,8(a0)
    80008150:	e798                	sd	a4,8(a5)
}
    80008152:	6422                	ld	s0,8(sp)
    80008154:	0141                	addi	sp,sp,16
    80008156:	8082                	ret

0000000080008158 <lst_pop>:

void*
lst_pop(struct list *lst) {
    80008158:	1101                	addi	sp,sp,-32
    8000815a:	ec06                	sd	ra,24(sp)
    8000815c:	e822                	sd	s0,16(sp)
    8000815e:	e426                	sd	s1,8(sp)
    80008160:	1000                	addi	s0,sp,32
  if(lst->next == lst)
    80008162:	6104                	ld	s1,0(a0)
    80008164:	00a48d63          	beq	s1,a0,8000817e <lst_pop+0x26>
    panic("lst_pop");
  struct list *p = lst->next;
  lst_remove(p);
    80008168:	8526                	mv	a0,s1
    8000816a:	00000097          	auipc	ra,0x0
    8000816e:	fd8080e7          	jalr	-40(ra) # 80008142 <lst_remove>
  return (void *)p;
}
    80008172:	8526                	mv	a0,s1
    80008174:	60e2                	ld	ra,24(sp)
    80008176:	6442                	ld	s0,16(sp)
    80008178:	64a2                	ld	s1,8(sp)
    8000817a:	6105                	addi	sp,sp,32
    8000817c:	8082                	ret
    panic("lst_pop");
    8000817e:	00002517          	auipc	a0,0x2
    80008182:	bca50513          	addi	a0,a0,-1078 # 80009d48 <userret+0xcb8>
    80008186:	ffff8097          	auipc	ra,0xffff8
    8000818a:	3d4080e7          	jalr	980(ra) # 8000055a <panic>

000000008000818e <lst_push>:
...
lst_push(struct list *lst, void *p)
{
  ...
  e->next = lst->next;
    80008194:	611c                	ld	a5,0(a0)
    80008196:	e19c                	sd	a5,0(a1)
  e->prev = lst;
    80008198:	e588                	sd	a0,8(a1)
  lst->next->prev = p;
    8000819a:	611c                	ld	a5,0(a0)
    8000819c:	e78c                	sd	a1,8(a5)
  lst->next = e;
    8000819e:	e10c                	sd	a1,0(a0)
}
    800081a0:	6422                	ld	s0,8(sp)
    800081a2:	0141                	addi	sp,sp,16
    800081a4:	8082                	ret

00000000800081a6 <lst_print>:

void
lst_print(struct list *lst)
{
    800081a6:	7179                	addi	sp,sp,-48
    800081a8:	f406                	sd	ra,40(sp)
    800081aa:	f022                	sd	s0,32(sp)
    800081ac:	ec26                	sd	s1,24(sp)
    800081ae:	e84a                	sd	s2,16(sp)
    800081b0:	e44e                	sd	s3,8(sp)
    800081b2:	1800                	addi	s0,sp,48
  for (struct list *p = lst->next; p != lst; p = p->next) {
    800081b4:	6104                	ld	s1,0(a0)
    800081b6:	02950063          	beq	a0,s1,800081d6 <lst_print+0x30>
    800081ba:	892a                	mv	s2,a0
    printf(" %p", p);
    800081bc:	00002997          	auipc	s3,0x2
    800081c0:	b9498993          	addi	s3,s3,-1132 # 80009d50 <userret+0xcc0>
    800081c4:	85a6                	mv	a1,s1
    800081c6:	854e                	mv	a0,s3
    800081c8:	ffff8097          	auipc	ra,0xffff8
    800081cc:	3ec080e7          	jalr	1004(ra) # 800005b4 <printf>
  for (struct list *p = lst->next; p != lst; p = p->next) {
    800081d0:	6084                	ld	s1,0(s1)
    800081d2:	fe9919e3          	bne	s2,s1,800081c4 <lst_print+0x1e>
  }
  printf("\n");
    800081d6:	00001517          	auipc	a0,0x1
    800081da:	0ba50513          	addi	a0,a0,186 # 80009290 <userret+0x200>
    800081de:	ffff8097          	auipc	ra,0xffff8
    800081e2:	3d6080e7          	jalr	982(ra) # 800005b4 <printf>
}
    800081e6:	70a2                	ld	ra,40(sp)
    800081e8:	7402                	ld	s0,32(sp)
    800081ea:	64e2                	ld	s1,24(sp)
    800081ec:	6942                	ld	s2,16(sp)
    800081ee:	69a2                	ld	s3,8(sp)
    800081f0:	6145                	addi	sp,sp,48
    800081f2:	8082                	ret
	...
